...
The System Doctor intentionally proves only facts already owned by Nerelan.
Checks whose canonical owners have not landed on the integration base remain
explicitly UNKNOWN instead of being guessed from ambient host state.
"""
...
def aggregate_state(checks: tuple[DoctorCheck, ...]) -> str:
    """Apply the closed fail-closed precedence defined by OPS-3A."""
...
class SystemDoctor:
    """Aggregate bounded provider-free readiness facts without side effects."""
