...
def detect_control_plane_mode(
    ...
    *,
    ...
    A pull request whose head is bound to the active Decision keeps the
    Decision-selected transition/legacy path. Every other pull request is an
    ordinary Path-A candidate and must run the Path-A verifier; invalid or
    missing Path-A data therefore cannot fall back to Decision state.
    """
