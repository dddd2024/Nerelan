...
ARCHIVE_MINIMAL_ALLOWED_NAMES = (*ARCHIVE_MINIMAL_NAMES, "pytest_result.txt", "execution_report.md", ARCHIVE_MANIFEST_NAME)
...
def _historical_artifact_freshness_is_non_blocking(
    *,
    ...
    # Path 2: active engineering_branch or training_dataset round where the
    # report is not yet SUCCESS but does not claim sample artifact freshness.
