...
## 6b. Allowed Inherited Dirty Baseline Files

Files below may already be dirty at the start of this rework round. Codex must record them as inherited baseline when applicable and distinguish inherited baseline from new round delta. Do not treat unrelated inherited dirty files as permission to modify them.
