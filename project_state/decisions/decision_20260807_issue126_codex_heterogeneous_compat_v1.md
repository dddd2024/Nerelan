...
1. `pr_comment_allowed=false` 鈥?blocks the Owner attestation PR comment on PR #121
...
```
Owner attestation 鈫?Ready 鈫?merge
```
...
- `auto_merge_allowed=false` 鈥?no auto-merge.
