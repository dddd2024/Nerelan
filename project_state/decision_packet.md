...
{
  "schema_version": 1,
  "decision_id": "decision_20260819_issue250_ci_repair_r2_v2",
  "round_id": "round_20260819_issue250_ci_repair_r2_v2",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "follows_last_decision_id": "decision_20260819_issue250_platform_completion_r2_v1",
  "follows_last_round_id": "round_20260819_issue250_platform_completion_r2_v1",
  "previous_audit_outcome": "ISSUE250_DRAFT_PR_251_CI_BLOCKED_BY_MISSING_HEAD_DECISION_AND_FRONTEND_LINT",
  "workstream_id": "issue250-ci-repair-r2-v2",
  "source_issue": 250,
  "superseded_pr": 251,
  "required_branch": "owner/issue250-platform-completion-v2",
  "starting_head": "706991ad0cb826d7c963a8ddfb7e770e97cdf60b",
  "activation_base_sha": "706991ad0cb826d7c963a8ddfb7e770e97cdf60b",
  "integration_base_ref": "main",
  "authority_and_product_worktree": "F:/reverse-agent-issue250-platform-completion-v2",
  "risk_tier": "R2",
  ...
  "bootstrap_exception_commands": [
    "git worktree add -b owner/issue250-platform-completion-v2 F:/reverse-agent-issue250-platform-completion-v2 706991ad0cb826d7c963a8ddfb7e770e97cdf60b",
  ...
  "allowed_commands": [
    {
      "command_id": "issue250v2.verify_exact_state",
    ...
    {
      "command_id": "issue250v2.reuse_exact_product_commit",
    ...
    {
      "command_id": "issue250v2.install_frontend_lockfile",
    ...
    {
      "command_id": "issue250v2.fix_frontend_lint",
    ...
    {
      "command_id": "issue250v2.frontend_validation",
    ...
    {
      "command_id": "issue250v2.backend_validation",
    ...
    {
      "command_id": "issue250v2.platform_validation",
    ...
    {
      "command_id": "issue250v2.repository_validation",
    ...
    {
      "command_id": "issue250v2.commit_lint_repair",
      "command": "git add only frontend/src/lib/platform-client.ts and frontend/src/routes/home.tsx; git commit -m 'fix: satisfy frontend CI lint'",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue250v2.push_once",
      "command": "git push origin HEAD:refs/heads/owner/issue250-platform-completion-v2",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue250v2.replace_draft_pr",
      "command": "close PR 251 as superseded, create one Draft PR from owner/issue250-platform-completion-v2 to main, and comment Issue 250",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
  ...
  "success_terminal": "ISSUE250_REPLACEMENT_DRAFT_PR_EXACT_HEAD_CI_READY",
  "blocked_terminal": "ISSUE250_CI_REPAIR_BLOCKED_WITH_EXACT_EVIDENCE"
}
```

## Goal

Repair the two exact PR #251 CI failures without changing the accepted Platform V2 product scope: place immutable Path-B authority before product implementation in branch history and correct the reported frontend lint findings.

## Acceptance

1. The Decision commit is the first commit after the exact main base and remains immutable.
2. The accepted v1 product tree is replayed exactly before the two-file lint repair.
