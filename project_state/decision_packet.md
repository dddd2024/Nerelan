...
```json decision_contract
{
  ...
  "workstream_id": "issue370-strict-freshness-control-r2-v4",
  "source_issue": 370,
  "parent_issue": 367,
  ...
  "required_branch": "owner/issue370-strict-freshness-control-r2-v4",
  "risk_tier": "R2",
  ...
  "bootstrap_exception_commands": [
    "verify exact main base 0b1f30129fa770f394d7eb6d844fa962ea5a7cde and fresh strict-freshness-control v4 branch merge-base",
  ...
  "allowed_commands": [
    {
      "command_id": "issue370_r2v4.bootstrap",
      "command": "verify locked main base and fresh strict-freshness-control v4 branch; commit the immutable Decision as the unique first commit; generate the five governance gates; require PRE_EXECUTION_AUTHORIZED and PUBLICATION_READY",
      "phase": "bootstrap",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue370_r2v4.diff_check",
    ...
    {
      "command_id": "issue370_r2v4.publish_control_draft",
    ...
    {
      "command_id": "issue370_r2v4.bind_schema3_intent",
    ...
    {
      "command_id": "issue370_r2v4.exact_head_checks",
    ...
    {
      "command_id": "issue370_r2v4.audit_attestation_comments",
      "command": "after exact-head checks, create exactly one independent audit comment and one attestation placeholder comment, then finalize the attestation once and revoke once if BEHIND",
      "phase": "acceptance",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue370_r2v4.ready_clean_at_b",
    ...
    {
      "command_id": "issue370_r2v4.behind_revocation_closeout",
    ...
    {
      "command_id": "issue370_r2v4.final_tracked_preflight",
  ...
  "forbidden_operations": [
    ...
    "tag_or_release",
    "deployment",
    "pull_request_comment_more_than_two_creates",
    "pull_request_comment_more_than_two_edits",
    "dependency_install",
    "browser_execution",
    "snapshot_update",
  ...
  "pull_request_comment_create_attempt_limit": 2,
  "pull_request_comment_edit_attempt_limit": 2,
  "audit_comment_create_attempt_limit": 1,
  "attestation_placeholder_comment_create_attempt_limit": 1,
  "attestation_finalize_comment_edit_attempt_limit": 1,
  "revocation_comment_edit_attempt_limit": 1,
  "issue_comment_create_attempt_limit": 1,
  ...
  "unpublished_rejected_observations": [
    {
      ...
      "remote_pr": null,
      "reason": "semantic contradiction: active intent was also declared reference-only"
    },
    {
      ...
      "status": "REJECTED_UNPUBLISHED",
      "remote_pr": null,
      "reason": "superseded local preparation; no remote publication authority"
    }
  ],
