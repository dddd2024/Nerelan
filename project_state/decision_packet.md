...
{
  "schema_version": 1,
  "decision_id": "decision_20260901_issue492_final_visual_golden_r3_v12",
  "round_id": "round_20260901_issue492_final_visual_golden_r3_v12",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "follows_last_decision_id": "decision_20260901_issue492_final_visual_golden_r3_v11",
  "follows_last_round_id": "round_20260901_issue492_final_visual_golden_r3_v11",
  "previous_audit_outcome": "R3_V11_FAIL_CLOSED_EXACT_HEAD_CI_INTENT_WORKFLOW_POLICY_MISMATCH_BROWSER_R3_REQUIRES_FIVE_WORKFLOWS;R3_V10_FAIL_CLOSED_OWNER_SIDE_UNAUTHORIZED_HANDOFF_PATH_AFTER_ACTIVATION_NO_PREFLIGHT_EXECUTED;R3_V9_FAIL_CLOSED_PRE_PRODUCT_OVERBROAD_SNAPSHOT_WILDCARD_AND_INACCURATE_V8_AUDIT_LABEL;R3_V8_FAIL_CLOSED_AFTER_VISUAL_REPLAY_GOLDEN_REPLAY_AND_PR522_WHEN_MAIN_ADVANCED_VIA_PR519;PR520_PLAYWRIGHT_40_PASS_8_SKIP_0_FAIL",
  "workstream_id": "issue492-final-visual-golden-r3-v12",
  "source_issue": 492,
  "parent_issue": 448,
  ...
  "required_branch": "owner/issue492-final-visual-golden-r3-v12",
  ...
  "allowed_commands": [
    {
      "command_id": "issue492_r3v12.bootstrap_and_preflight",
    ...
    {
      "command_id": "issue492_r3v12.replay_visual_surface",
    ...
    {
      "command_id": "issue492_r3v12.materialize_locked_goldens",
    ...
    {
      "command_id": "issue492_r3v12.validate_publish",
    ...
    {
      "command_id": "issue492_r3v12.post_publication_binding",
      "command": "after the real Draft PR number is known archive the inherited schema-v3 PR499 active merge intent byte-for-byte as project_state/mainline_merge_intents/archive/pr499_v1.json and bind active.json once to the exact new PR locked base current Decision current Command Plan and browser_r3 workflow profile; schema-v3 required_workflows MUST contain exactly the five trusted browser_r3 premerge workflows CI Decision Preflight State Gate (pull_request) Frontend Playwright and Model Access and none of them is supplementary or outside required_workflows; merge policy remains merge-only",
    ...
    {
      "command_id": "issue492_r3v12.browser_exact_head_acceptance",
    ...
    {
      "command_id": "issue492_r3v12.finalize_design_qa",
    ...
    {
      "command_id": "issue492_r3v12.final_exact_head_acceptance",
