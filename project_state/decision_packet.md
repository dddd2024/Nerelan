...
{
  "schema_version": 1,
  "decision_id": "decision_20260827_issue370_strict_freshness_advance_r2_v10",
  "round_id": "round_20260827_issue370_strict_freshness_advance_r2_v10",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "previous_audit_outcome": "ISSUE370_V8_REWORK_REQUIRED_UNPUBLISHED",
  "workstream_id": "issue370-strict-freshness-advance-r2-v10",
  "source_issue": 370,
  ...
  "required_branch": "owner/issue370-strict-freshness-advance-r2-v10",
  "risk_tier": "R2",
  ...
  "allowed_commands": [
    {
      "command_id": "issue370_r2v10.bootstrap_governance",
    ...
    {
      "command_id": "issue370_r2v10.publish_governed_draft",
    ...
    {
      "command_id": "issue370_r2v10.bind_schema3_intent",
    ...
    {
      "command_id": "issue370_r2v10.exact_head_checks",
      "command": "run only python -m pytest tests/test_project_gate.py tests/test_mainline_landing.py -q and git diff --check against the exact Draft PR head; require first-run success without retry and do not modify product, source, test, workflow, dependency, or credential paths",
      "phase": "validation",
      "required": true,
      "required_evidence_source": "repository_state_attestation",
      "expected_exit_codes": [
      ...
      "produced_artifacts": [],
      "subject_to_reconciliation": true,
      "allowed_mutated_paths": []
    },
    {
      "command_id": "issue370_r2v10.final_tracked_preflight",
  ...
  "control_h_publication_precondition": {
    "required_pr_number": 394,
    "required_head_sha": "187a92da976a0ed286473aa54bc791bb2d5c7c87",
    ...
    "required_merged": false,
    "required_mergeable": "MERGEABLE",
    ...
    "fresh_server_readback_required_before_first_push": true,
    "latest_exact_head_checks_required": true,
    "latest_exact_head_check_run_ids": {
      "baseline": 33069164009,
      "decision_preflight": 33069163967,
      "state_gate": 33069165252
    },
    "independent_audit_required": true,
    "audit_comment_id": 5438763500,
    "attestation_required": true,
    "attestation_comment_id": 5438775121,
    "attestation_content_digest": "sha256:c4df7230e4013def3e89acf3ad0aefa3318784c3616c2f1c80a6c039963a78b0",
    "attestation_expires_at": "2026-08-28T05:30:00Z",
    "ready_event_id": 30101954784,
    "ready_state_gate_run_id": 33070351948,
    "ready_state_gate_attempt": 1,
    "ready_state_gate_conclusion": "success",
    "required_remote_readback_fields": [
      "pr_number",
      "head_sha",
      "base_ref",
      "base_sha",
  ...
  "prior_rework_observation": {
    "decision_id": "decision_20260827_issue370_strict_freshness_advance_r2_v8",
    "round_id": "round_20260827_issue370_strict_freshness_advance_r2_v8",
    "status": "REWORK_REQUIRED_UNPUBLISHED",
    "reason": "advance v8 was not publication-ready because first-push precondition did not bind PR394 and latest exact-head/audit/attestation evidence",
    "remote_pr": null
  },
  "authority_expiry": "2026-09-04T23:59:59Z",
