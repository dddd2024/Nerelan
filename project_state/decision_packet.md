...
{
  "schema_version": 1,
  "decision_id": "decision_20260810_issue176_task3c_narrow_relay_r2_v2",
  "round_id": "round_20260810_issue176_task3c_narrow_relay_r2_v2",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "follows_last_decision_id": "decision_20260810_issue176_task3c_narrow_relay_r2_v1",
  "follows_last_round_id": "round_20260810_issue176_task3c_narrow_relay_r2_v1",
  "previous_audit_outcome": "TASK3C_R2_V1_PREFLIGHT_BLOCKED_INVALID_TRANSITION_AUTHORITY",
  "workstream_id": "issue176-task3c-narrow-relay-r2-v2",
  "source_issue": 176,
  "parent_issue": 172,
  "required_branch": "owner/issue176-task3c-narrow-relay-r2-v2",
  ...
  "capability_policy": {
    ...
    "local_network_exceptions": [
      "git push origin owner/issue176-task3c-narrow-relay-r2-v2"
    ],
  ...
  "bootstrap_exception_commands": [
    ...
    "git -C F:\\reverse-agent-issue170-task3b-r1-20260810 fetch origin owner/issue176-task3c-narrow-relay-r2-v2",
    "git -C F:\\reverse-agent-issue170-task3b-r1-20260810 worktree list --porcelain",
    "git -C F:\\reverse-agent-issue170-task3b-r1-20260810 branch --list owner/issue176-task3c-narrow-relay-r2-v2",
    "git -C F:\\reverse-agent-issue170-task3b-r1-20260810 worktree add --track -b owner/issue176-task3c-narrow-relay-r2-v2 F:\\reverse-agent-issue176-task3c-r2-v2 origin/owner/issue176-task3c-narrow-relay-r2-v2",
    "git status --short",
    "git rev-parse HEAD",
  ...
  "allowed_commands": [
    ...
    },
    {
      ...
      "command": "git push origin owner/issue176-task3c-narrow-relay-r2-v2",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
...
This v2 Decision supersedes only the blocked v1 execution authority. The v1 Decision remains immutable in its own branch history and is referenced above as the predecessor.

The v1 preflight failed before product implementation because its contract omitted the structured `capability_policy` shape required by the transition loader. Owner audit also found two latent v1 contract defects that are corrected here: mutable product paths are no longer duplicated in `reference_paths`, and path validation now observes working, staged, and product-commit deltas rather than comparing only the already-committed Decision to the planning base.

The local checkout used for the blocked v1 attempt must not be cleaned or reused for v2 implementation. The report disclosed `git checkout -- .` restoration of stale tracked gate artifacts. That cleanup action is not carried forward as authority. v2 must use a new worktree at `F:\reverse-agent-issue176-task3c-r2-v2`; if that path or local v2 branch already exists unexpectedly, stop rather than deleting/reusing it.
...
The current Docker-hosted LiteLLM path remains rejected because #175 proved the same Windows user can recover the container's fake provider master through Docker control. No further gateway candidate research is authorized.
