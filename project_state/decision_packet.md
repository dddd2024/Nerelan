...
{
  "schema_version": 1,
  "decision_id": "decision_20260912_issue825_goal_completion_evidence_r2_v1",
  "round_id": "round_20260912_issue825_goal_completion_evidence_r2_v1",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "source_issue_body_sha256": "477a0029c8c930cd1e50bd0a4db5698836f2e62e06817fde01ab1b09a954b7d1",
  ...
  "required_branch": "codex/f03-goal-completion-evidence-r2-v1",
  ...
  "capability_policy": {
    ...
    "github_control_plane_network_exceptions": [
      "After local checks pass, push only codex/f03-goal-completion-evidence-r2-v1; create/update one Draft PR in dddd2024/Nerelan against main@00d203d954b29a26edfb0811f39a85590940c070; publish a disclosed exact-head self-review and progress comments only on Issue825/653/659.",
      "After fresh preflight, reobserve PR810 merged at 00d203d954b29a26edfb0811f39a85590940c070 with exact parents/tree and natural mainline acceptance. Publish one F02 completion evidence comment each on Issues799/652/659. Close only Issues799 and652 as completed after verifying their complete acceptance. This exact Issue close is an explicitly bounded GitHub API network operation, not an issue_comment operation. No approved Issue body update and no unrelated Issue closure.",
  ...
  "allowed_commands": [
    ...
    {
      "command_id": "issue825.publish",
      "command": "After local checks pass, push only codex/f03-goal-completion-evidence-r2-v1; create/update one Draft PR in dddd2024/Nerelan against main@00d203d954b29a26edfb0811f39a85590940c070; publish a disclosed exact-head self-review and progress comments only on Issue825/653/659.",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue825.bookkeeping",
      "command": "After fresh preflight, reobserve PR810 merged at 00d203d954b29a26edfb0811f39a85590940c070 with exact parents/tree and natural mainline acceptance. Publish one F02 completion evidence comment each on Issues799/652/659. Close only Issues799 and652 as completed after verifying their complete acceptance. This exact Issue close is an explicitly bounded GitHub API network operation, not an issue_comment operation. No approved Issue body update and no unrelated Issue closure.",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [
        0
