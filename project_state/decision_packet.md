...
{
  "schema_version": 1,
  "decision_id": "decision_20260912_issue828_pr827_owner_landing_r2_v1",
  "round_id": "round_20260912_issue828_pr827_owner_landing_r2_v1",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "target_pr": 827,
  "source_pr": 827,
  "target_branch": "codex/f03-goal-completion-evidence-r2-v2",
  "accepted_exact_head_sha": "fc788be9d98fbb733db454af14ec103cd7427554",
  ...
  "fresh_base": "00d203d954b29a26edfb0811f39a85590940c070",
  "current_main_expected": "00d203d954b29a26edfb0811f39a85590940c070",
  "integration_base_ref": "main",
  "required_branch": "codex/pr827-owner-landing-r2-v1",
  "source_issue": 828,
  "parent_issue": 826,
  "trigger_issue": 826,
  "trigger_pr": 827,
  "owner_exact_head_review_id": 5184998266,
  "owner_exact_head_review_commit": "fc788be9d98fbb733db454af14ec103cd7427554",
  "target_decision_content_sha256": "7e3f716e40194b177dc291d6412b65b1ff82d05a0e486998e62d8ace430744cb",
  "follows_last_decision_id": "decision_20260912_issue826_goal_completion_evidence_r2_v2",
  "follows_last_round_id": "round_20260912_issue826_goal_completion_evidence_r2_v2",
  "previous_audit_outcome": "PR827_EXACT_HEAD_fc788be9d98fbb733db454af14ec103cd7427554_DISCLOSED_CODEX_SELF_AUDIT_ACCEPTED_OWNER_REVIEW_5184998266",
  "workstream_id": "issue828-pr827-owner-landing-r2-v1",
  ...
  "landing_authority_scope_note": "Validation-only / landing-authority-only sidecar v1 for PR #827. This immutable R2 Decision binds target_pr=827, source_pr=827, target_branch=codex/f03-goal-completion-evidence-r2-v2, accepted_exact_head_sha=fc788be9d98fbb733db454af14ec103cd7427554, base_sha=00d203d954b29a26edfb0811f39a85590940c070, integration_base_ref=main. It grants the Owner exactly-once Mark Ready and exactly-one expected-head protected regular merge of PR #827 using merge method merge, only after the natural target Ready-triggered landing-state-gate reports terminal SUCCESS on the unchanged exact target head fc788be9d98fbb733db454af14ec103cd7427554 with contexts baseline=success, state-gate=success, landing-state-gate=success. The sidecar authority PR itself must remain Draft forever and must never be marked Ready or merged. mainline_merge_intent_required=false + active_pr_binding_mode=none is the false/none cutover contract; project_state/mainline_merge_intents/active.json is never read or rewritten and active_json_rewrite is forbidden. No target-branch push, no target semantic mutation, no workflow rerun or dispatch, no runner dispatch, no direct main push, no auto-merge, no force push and no rebase. Publication retry accounting: maximum 3 total push invocations and 2 total PR-create invocations; transport failures consume an attempt; retry only if read-only remote observation proves no remote mutation occurred. Owner actions in this round are explicitly delegated to Codex by the user and must be disclosed as agent actions. No independent human review is claimed.",
  ...
  "owner_landing_bounds": {
    ...
    "allowed_merge_method": "merge",
    "expected_head_protection_required": true,
    "expected_head": "fc788be9d98fbb733db454af14ec103cd7427554"
  },
  "required_landing_sequence": [
    "sidecar requires only natural CI, Decision Preflight and State Gate on the exact sidecar head",
    "re-check main == 00d203d954b29a26edfb0811f39a85590940c070, target PR #827 head == fc788be9d98fbb733db454af14ec103cd7427554, target PR #827 still OPEN, DRAFT and unmerged",
    "mark target PR #827 Ready exactly once",
    "observe a NEW natural target State Gate triggered by Ready",
    "require unchanged exact target head fc788be9d98fbb733db454af14ec103cd7427554 and contexts baseline=success, state-gate=success, landing-state-gate=success",
    "explicitly reject landing-state-gate-draft-inert as formal landing evidence",
    "publish exactly one pre-merge structured comment OWNER_LANDING_MERGE_ATTESTATION with JSON block owner_landing_merge_attestation on target PR #827",
    "fresh no-drift check",
    "merge target PR #827 exactly once with method=merge and expected head fc788be9d98fbb733db454af14ec103cd7427554"
  ],
  ...
  "allowed_commands": [
    ...
    {
      "command_id": "pr827_owner_landing_r2_v1.validate",
    ...
    {
      "command_id": "pr827_owner_landing_r2_v1.materialize_generated_authority",
      "command": "commit exactly one generated governance commit chore: materialize PR827 landing authority R2 v1 containing only project_state/gates/command_plan.json project_state/gates/transition_command_plan_preview.json and project_state/gates/transition_preflight_result.json; no product semantic commit exists in this sidecar and project_state/gates/bootstrap_state.json is never committed; if another tracked commit is necessary FAIL CLOSED",
    ...
    {
      "command_id": "pr827_owner_landing_r2_v1.publish_authority",
      "command": "after all blocking validation passes, push only the exact authority branch codex/pr827-owner-landing-r2-v1 to locked main 00d203d954b29a26edfb0811f39a85590940c070 and create exactly one Draft authority sidecar PR recording the immutable authority snapshot; keep the sidecar Draft forever and never mark Ready or merge the sidecar; never push the target branch codex/f03-goal-completion-evidence-r2-v2 and never push main; never rerun or dispatch workflows; publication retry accounting: maximum 3 total push invocations with transport retries only when read-only remote observation confirms no remote mutation; maximum 2 total PR-create invocations with retry only when read-only GitHub search confirms no existing PR for this exact head/base and successful_draft_pr_creation_count==0; after first successful remote push NO further push invocation; after first successfully created Draft PR NO second creation call",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "pr827_owner_landing_r2_v1.natural_authority_validation",
      "command": "require natural exact-head CI, Decision Preflight and State Gate observations on the authority Draft PR head and confirm no main drift from 00d203d954b29a26edfb0811f39a85590940c070 and no target head drift from fc788be9d98fbb733db454af14ec103cd7427554 and no concurrent landing authority; keep the authority PR Draft and do NOT mark Ready or merge; the authority grants the Owner exactly-once Mark Ready and exactly-one expected-head protected merge of target PR 827 only after a formal Ready-triggered landing-state-gate success and required exact-head contexts baseline state-gate landing-state-gate",
    ...
    {
      "command_id": "pr827_owner_landing_r2_v1.postmerge_bookkeeping",
      "command": "Only after target PR827 ordinary merge and verified actual parents/tree/main, native mainline integration receipt and natural main CI/State SUCCESS with unchanged diagnostic failure nodes: post exactly one evidence-summary Issue comment to826 and close Issue826 completed; post at most one progress comment each to653 and659 and leave653 and659 OPEN. No Issue body edit, unrelated closure, authority Issue or Draft closure, or repeated mutation. Resolve ambiguous writes by readback before any retry.",
      "phase": "final_evidence",
      "required": true,
      "expected_exit_codes": [
        0
  ...
  "capability_policy": {
    ...
    "github_control_plane_network_exceptions": [
      ...
      "Only after target PR827 ordinary merge and verified actual parents/tree/main, native mainline integration receipt and natural main CI/State SUCCESS with unchanged diagnostic failure nodes: post exactly one evidence-summary Issue comment to826 and close Issue826 completed; post at most one progress comment each to653 and659 and leave653 and659 OPEN. No Issue body edit, unrelated closure, authority Issue or Draft closure, or repeated mutation. Resolve ambiguous writes by readback before any retry."
    ],
  ...
  "target_decision_contract": {
    ...
    "content_sha256": "7e3f716e40194b177dc291d6412b65b1ff82d05a0e486998e62d8ace430744cb",
    "mainline_merge_intent_required": false,
    "active_pr_binding_mode": "none",
  ...
  "target_acceptance_evidence": {
    ...
    "natural_runs": [
      {
        ...
        "run_number": 1213,
        "conclusion": "success",
        "head_sha": "fc788be9d98fbb733db454af14ec103cd7427554"
      },
      {
    ...
    "model_access_expected": "EXPECTED_NO_EXISTING_PATH_FILTERS",
    "playwright_expected": "EXPECTED_NO_EXISTING_PATH_FILTERS",
    "local_required_tests": "357 exact-head tests passed in553.90s; 28 new Goal proof tests; actual HTTP Git SQLite pytest single/team and reopen with disclosed execution/binding doubles; diff hygiene/preflight/readiness PASS",
    "diagnostic_summary": "22 failed, 6327 passed, 23 skipped, 1 warning in 517.86s (0:08:37)"
  },
  "run_environment_binding": {
    "run_strategy": "trusted_worker",
    "canonical_repository": "dddd2024/Nerelan",
    "target_owner_branch": "codex/pr827-owner-landing-r2-v1",
    "target_product_branch": "codex/f03-goal-completion-evidence-r2-v2",
  ...
  "source_issue_body_sha256": "2c7226bdb93a57574243c00b44db3e73e5faa3d30dc7ae2a53a990bdee7812a7",
