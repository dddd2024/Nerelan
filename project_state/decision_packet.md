...
{
  "schema_version": 1,
  "decision_id": "decision_20260911_issue784_artifact_handoff_r2_v3",
  "round_id": "round_20260911_issue784_artifact_handoff_r2_v3",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "source_issue_body_sha256": "b847a075ccacbc65ccaa990575476ae6ace87b259ffe2e13a7c35c9b27304cea",
  ...
  "required_branch": "codex/f02-accepted-artifact-handoff-r2-v3",
  ...
  "capability_policy": {
    ...
    "github_control_plane_network_exceptions": [
      "After blocking checks pass, push only codex/f02-accepted-artifact-handoff-r2-v3 and create/update one Draft PR in dddd2024/Nerelan against main at 6c41aae9b9e148c658d3f9dece9ba71338e82611; publish disclosed audit/evidence and Issue 784/652/659 progress comments; no other branch or repository publication.",
  ...
  "allowed_commands": [
    ...
    {
      "command_id": "issue784.implement",
      "command": "After fresh activation/preflight, copy only the eight hash-bound product candidate files from preserved stopped Issue783 as specified in Issue784, never old Decision/gates/commits. Repair validation-only input consumer routing with honest skipped model roles, preserve implementation coder-diff requirements, and correct durable planner input HEAD checks as specified in the Issue. Preserve negative input rejection coverage by using prepared-worktree injection seams when model execution is correctly skipped. Implement the complete F02 explicit accepted-artifact input contract and exactly twenty-six source/frontend/test/documentation paths in Issue784. Reuse existing Git object/private-index/worktree preparation, TaskStore evidence/lease/checkpoints and all ordinary/durable single/team execution and recovery paths. Preserve frozen approved base separately from exact producer input commit/tree. Include validation-only immutability, UI selection/review and safe consumed-input evidence. Bounded local retention refs/nerelan/accepted-artifacts/<task-id>/<execution-id> use create-if-absent with identical-binding idempotence only, no remote publication or arbitrary ref mutation. No second database, runner, coordinator or Gate; no workflow/dependency/provider/credential/browser/reverse-tool change.",
    ...
    {
      "command_id": "issue784.publish",
      "command": "After blocking checks pass, push only codex/f02-accepted-artifact-handoff-r2-v3 and create/update one Draft PR in dddd2024/Nerelan against main at 6c41aae9b9e148c658d3f9dece9ba71338e82611; publish disclosed audit/evidence and Issue 784/652/659 progress comments; no other branch or repository publication.",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [
        0
