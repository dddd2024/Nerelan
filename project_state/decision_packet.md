...
{
  "schema_version": 1,
  "decision_id": "decision_20260817_issue228_dogfood1_one_shot_live_r2_v1",
  "round_id": "round_20260817_issue228_dogfood1_one_shot_live_r2_v1",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "follows_last_decision_id": "decision_20260817_issue227_opencode_executor_managed_gate_r2_v1",
  "follows_last_round_id": "round_20260817_issue227_opencode_executor_managed_gate_r2_v1",
  "previous_audit_outcome": "ISSUE227_EXECUTOR_MANAGED_OPENCODE_GATE_ACCEPTED_AND_LANDED",
  "workstream_id": "issue228-dogfood1-one-shot-live-r2-v1",
  "source_issue": 228,
  "parent_issue": 148,
  "required_branch": "owner/issue228-dogfood1-one-shot-live-r2-v1",
  ...
  "authority_worktree": "F:/reverse-agent-issue228-dogfood1-one-shot-live-r2-v1",
  "risk_tier": "R2",
  ...
  "external_harness_write_path": "F:/reverse-agent-issue228-dogfood1-live-v1/dogfood1_live.py",
  "external_runtime_write_allowlist": [
    "F:/reverse-agent-issue228-dogfood1-live-v1/**"
  ],
  "prompt_temp_root": "F:/reverse-agent-issue228-dogfood1-live-v1/temp",
  "disposable_task_store_path": "F:/reverse-agent-issue228-dogfood1-live-v1/runtime/tasks.sqlite3",
  "disposable_seed_repo": "F:/reverse-agent-issue228-dogfood1-live-v1/seed-repo",
  "disposable_workspace_root": "F:/reverse-agent-issue228-dogfood1-live-v1/workspaces",
  "canonical_setup": {
  ...
  "bootstrap_exception_commands": [
    ...
    "git -C F:/reverse-agent-planning-smoke rev-parse origin/owner/issue228-dogfood1-one-shot-live-r2-v1",
    "powershell -NoProfile -Command \"$b=(git -C F:/reverse-agent-planning-smoke branch --list owner/issue228-dogfood1-one-shot-live-r2-v1);if($b){'ISSUE228_V1_LOCAL_BRANCH_ALREADY_EXISTS';exit 25};if(Test-Path -LiteralPath 'F:/reverse-agent-issue228-dogfood1-one-shot-live-r2-v1'){'ISSUE228_V1_WORKTREE_ALREADY_EXISTS';exit 24};if(Test-Path -LiteralPath 'F:/reverse-agent-issue228-dogfood1-live-v1'){'ISSUE228_V1_EVIDENCE_ROOT_ALREADY_EXISTS';exit 23};if(-not (Test-Path -LiteralPath 'F:/reverse-agent/.platform_v1_runtime/model_setup_state.json')){'DOGFOOD1_PRODUCT_SETUP_MISSING';exit 22};'ISSUE228_V1_BOOTSTRAP_PRECONDITIONS_PASS'\"",
    "git -C F:/reverse-agent-planning-smoke worktree add --track -b owner/issue228-dogfood1-one-shot-live-r2-v1 F:/reverse-agent-issue228-dogfood1-one-shot-live-r2-v1 origin/owner/issue228-dogfood1-one-shot-live-r2-v1",
    "Set-Location F:/reverse-agent-issue228-dogfood1-one-shot-live-r2-v1",
    "git status --short",
    "git rev-parse HEAD",
  ...
  "allowed_commands": [
    {
      "command_id": "issue228v1.status_before",
    ...
    {
      "command_id": "issue228v1.evidence_root_create",
      "command": "powershell -NoProfile -Command \"New-Item -ItemType Directory -Path 'F:/reverse-agent-issue228-dogfood1-live-v1' -ErrorAction Stop | Out-Null; 'ISSUE228_V1_EVIDENCE_ROOT_CREATED'\"",
      "phase": "setup",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue228v1.one_shot_live",
    ...
    {
      "command_id": "issue228v1.status_final",
      "command": "git status --short",
      "phase": "status",
      "required": true,
      "expected_exit_codes": [0],
...
The external harness may be written only at `F:/reverse-agent-issue228-dogfood1-live-v1/dogfood1_live.py` after transition authorization. It is outside Git.
...
13. On success require: status `READY_FOR_REVIEW`; validation exit 0; changed files exactly `dogfood1_result.txt`; execution worktree marker bytes exactly `DOGFOOD1_OK\n`; `git status --porcelain` shows only the expected modification; no extra untracked files; runtime event metadata proves provider `sensetime`, model `sensetime/sensenova-6.7-flash-lite`, auth method `external_cli_session`, and exactly one OpenCode-start event.
