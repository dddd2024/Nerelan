...
{
  "schema_version": 1,
  "decision_id": "decision_20260902_issue492_final_visual_golden_r3_v14",
  "round_id": "round_20260902_issue492_final_visual_golden_r3_v14",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "follows_last_decision_id": "decision_20260902_issue492_final_visual_golden_r3_v13",
  "follows_last_round_id": "round_20260902_issue492_final_visual_golden_r3_v13",
  "previous_audit_outcome": "R3_V13_FAIL_CLOSED_OWNER_SIDE_DECISION_MUTATION_AFTER_ACTIVATION_COMMIT_449F68EA;ISSUE345_PROFILE_REGRESSION_REPAIR_LANDED_PR537_MAIN_0DA78DF5_POSTMERGE_CI_AND_STATE_GATE_SUCCESS;R3_V12_FAIL_CLOSED_EXACT_HEAD_CI_PLATFORM_V1_STALE_SCHEMA_V3_PROFILE_ASSERTIONS;R3_V11_FAIL_CLOSED_EXACT_HEAD_CI_INTENT_WORKFLOW_POLICY_MISMATCH_BROWSER_R3_REQUIRES_FIVE_WORKFLOWS;PR520_PLAYWRIGHT_40_PASS_8_SKIP_0_FAIL",
  "workstream_id": "issue492-final-visual-golden-r3-v14",
  "source_issue": 492,
  "parent_issue": 448,
  "prerequisite_issue": 345,
  "prerequisite_merge_commit": "0da78df5d2c5337ffeab17e3a00651df507637f0",
  ...
  "required_branch": "owner/issue492-final-visual-golden-r3-v14",
  ...
  "bootstrap_exception_commands": [
    "verify exact main base 0da78df5d2c5337ffeab17e3a00651df507637f0 and fresh branch merge-base",
  ...
  "allowed_commands": [
    ...
    {
      "command_id": "issue492_r3v14.replay_visual_surface",
      "command": "after PRE_EXECUTION_AUTHORIZED replay exactly frontend/e2e/fixtures.ts frontend/e2e/lifecycle-visual.spec.ts and frontend/design-qa.md byte-for-byte from the accepted PR520 pre-binding visual head 328e644461146229e0d31c3d8f7f01b9a46fb2a2; do not replay prior governance or intent history and do not modify production frontend runtime truth",
    ...
    {
      "command_id": "issue492_r3v14.materialize_locked_goldens",
    ...
    {
      "command_id": "issue492_r3v14.validate_publish",
    ...
    {
      "command_id": "issue492_r3v14.post_publication_binding",
      "command": "after the real Draft PR number is known archive the inherited schema-v3 PR537 active merge intent byte-for-byte as project_state/mainline_merge_intents/archive/pr537_v1.json and bind active.json once to the exact new PR locked base current Decision current Command Plan and browser_r3 workflow profile; schema-v3 required_workflows MUST contain exactly the five trusted browser_r3 premerge workflows CI Decision Preflight State Gate (pull_request) Frontend Playwright and Model Access; merge policy remains merge-only",
    ...
    {
      "command_id": "issue492_r3v14.browser_exact_head_acceptance",
    ...
    {
      "command_id": "issue492_r3v14.finalize_design_qa",
      ...
      "network_access": true,
      "required_evidence_source": "repository_state_attestation",
      "allowed_mutated_paths": ["frontend/design-qa.md"],
      "allowed_only_after_validation": true
    },
    {
      "command_id": "issue492_r3v14.final_exact_head_acceptance",
  ...
  "mainline_merge_intent_scope": {
    ...
    "archive_path": "project_state/mainline_merge_intents/archive/pr537_v1.json",
    "supersedes_intent_id": "pr537_issue345_platform_v1_profile_regression_r2_v1",
    "supersedes_source_issue": 345,
  ...
  "prepared_by": "owner",
  "approved_at": "2026-09-02T01:25:00Z",
  ...
  "capability_policy": {
    ...
    "local_network_exceptions": [
      ...
      "after the real Draft PR number is known archive the inherited schema-v3 PR537 active merge intent byte-for-byte as project_state/mainline_merge_intents/archive/pr537_v1.json and bind active.json once to the exact new PR locked base current Decision current Command Plan and browser_r3 workflow profile; schema-v3 required_workflows MUST contain exactly the five trusted browser_r3 premerge workflows CI Decision Preflight State Gate (pull_request) Frontend Playwright and Model Access; merge policy remains merge-only",
