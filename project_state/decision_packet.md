...
{
  "schema_version": 1,
  "decision_id": "decision_20260817_issue224_external_session_executor_managed_r2_v5",
  "round_id": "round_20260817_issue224_external_session_executor_managed_r2_v5",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "follows_last_decision_id": "decision_20260817_issue224_external_session_executor_managed_r2_v4",
  "follows_last_round_id": "round_20260817_issue224_external_session_executor_managed_r2_v4",
  "previous_audit_outcome": "ISSUE224_V4_SUPERSEDED_BEFORE_EXECUTION_BRANCH_CREATION_PERMISSION_AMBIGUITY",
  "supersedes_decision_id": "decision_20260817_issue224_external_session_executor_managed_r2_v4",
  ...
  "workstream_id": "issue224-external-session-executor-managed-r2-v5",
  "source_issue": 224,
  "parent_issue": 148,
  "required_branch": "owner/issue224-external-session-executor-managed-r2-v5",
  ...
  "branch_creation_scope": "local_tracking_branch_owner/issue224-external-session-executor-managed-r2-v5_only",
  ...
  "bootstrap_exception_commands": [
    ...
    "git fetch origin owner/issue224-external-session-executor-managed-r2-v5",
    "git rev-parse origin/owner/repository-modernization-v2-planning",
    "git rev-parse origin/owner/issue224-external-session-executor-managed-r2-v5",
    "powershell -NoProfile -Command \"$b=(git branch --list owner/issue224-external-session-executor-managed-r2-v5);if($b){'ISSUE224_V5_LOCAL_BRANCH_ALREADY_EXISTS';exit 25};'ISSUE224_V5_LOCAL_BRANCH_ABSENT'\"",
    "git switch -c owner/issue224-external-session-executor-managed-r2-v5 --track origin/owner/issue224-external-session-executor-managed-r2-v5",
    "git rev-parse HEAD",
  ...
  "allowed_commands": [
    {
      "command_id": "issue224v5.status_before",
    ...
    {
      "command_id": "issue224v5.package_json_blob_before",
    ...
    {
      "command_id": "issue224v5.package_lock_blob_before",
    ...
    {
      "command_id": "issue224v5.node_version",
    ...
    {
      "command_id": "issue224v5.npm_version",
      "command": "npm --version",
      "phase": "validation",
      "required": true,
      "expected_exit_codes": [0],
    ...
    {
      "command_id": "issue224v5.frontend_dependency_bootstrap",
    ...
    {
      "command_id": "issue224v5.package_json_blob_after",
      "command": "git hash-object frontend/package.json",
      "phase": "validation",
      "required": true,
      "expected_exit_codes": [0],
    ...
    {
      "command_id": "issue224v5.package_lock_blob_after",
      "command": "git hash-object frontend/package-lock.json",
      "phase": "validation",
      "required": true,
      "expected_exit_codes": [0],
    ...
    {
      "command_id": "issue224v5.package_manifest_diff",
    ...
    {
      "command_id": "issue224v5.python_focused_tests",
    ...
    {
      "command_id": "issue224v5.frontend_focused_test",
    ...
    {
      "command_id": "issue224v5.frontend_typecheck",
    ...
    {
      "command_id": "issue224v5.diff_check",
    ...
    {
      "command_id": "issue224v5.changed_paths_before_commit",
    ...
    {
      "command_id": "issue224v5.stage_exact_product",
    ...
    {
      "command_id": "issue224v5.staged_paths",
    ...
    {
      "command_id": "issue224v5.staged_diff_check",
    ...
    {
      "command_id": "issue224v5.commit_product",
    ...
    {
      "command_id": "issue224v5.head_after_commit",
    ...
    {
      "command_id": "issue224v5.compare_paths_after_commit",
    ...
    {
      "command_id": "issue224v5.push_branch",
      "command": "git push origin owner/issue224-external-session-executor-managed-r2-v5",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue224v5.remote_tracking_head",
      "command": "git rev-parse origin/owner/issue224-external-session-executor-managed-r2-v5",
      "phase": "status",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue224v5.status_final",
      "command": "git status --short",
      "phase": "status",
      "required": true,
      "expected_exit_codes": [0],
...
R2 V3 reached `PRE_EXECUTION_AUTHORIZED`, produced the complete nine-file authorized implementation, and passed its bounded Python validation (`247 passed, 1 skipped`), but correctly stopped before stage/commit because `frontend/node_modules` was absent and V3 explicitly forbade dependency installation. V4 was published as the first recovery draft but was superseded before local execution because its local tracking-branch creation permission was not expressed using the standard `branch_creation_allowed` field. V5 is the corrected recovery authority.

V5 intentionally reuses the preserved V3 worktree at `F:/reverse-agent-issue224-external-session-executor-managed-r2-v3`. Before switching authority, local execution must prove all of the following:
...
After `npm ci`, both blob hashes must remain exactly unchanged and `git diff --exit-code -- frontend/package.json frontend/package-lock.json` must exit 0. `frontend/node_modules/**` is local generated dependency state and is ignored by `frontend/.gitignore`; it must never be staged or committed.

No other dependency command is authorized. Do not use `npm install`, `npm update`, `npm audit fix`, pnpm, yarn, bun, pip installation, lockfile repair, or package-version changes. Dependency lifecycle scripts executed automatically by the canonical `npm ci` are permitted only as part of that exact command; no separate lifecycle-script invocation is authorized. If `npm ci` fails under the canonical lockfile or Node is below the required version, stop blocked rather than repair the environment ad hoc.
...
After environment recovery, rerun all V5-authorized Python and frontend validations. Do not rely solely on V3's earlier Python result for publication. Only after every required validation exits 0 may the exact nine product/test files be staged, committed once with the authorized message, and pushed to the V5 branch.
