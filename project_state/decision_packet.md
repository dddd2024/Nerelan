...
{
  "schema_version": 1,
  "decision_id": "decision_20260827_issue370_pr390_push_failure_containment_r2_v2",
  "round_id": "round_20260827_issue370_pr390_push_failure_containment_r2_v2",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "previous_audit_outcome": "PR390_SECOND_PUSH_TLS_UNEXPECTED_EOF_CONTAINMENT_REQUIRED",
  "workstream_id": "issue370-pr390-push-failure-containment-r2-v2",
  "source_issue": 370,
  ...
  "required_branch": "owner/issue370-pr390-push-failure-containment-r2-v2",
  "risk_tier": "R2",
  ...
  "bootstrap_exception_commands": [
    "verify exact main base 0b1f30129fa770f394d7eb6d844fa962ea5a7cde and fresh PR390 containment branch merge-base",
  ...
  "allowed_commands": [
    {
      "command_id": "issue370_pr390_containment.bootstrap",
      "command": "verify locked main base and fresh PR390 containment branch; commit the immutable Decision as the unique first commit; generate the five governance gates; require PRE_EXECUTION_AUTHORIZED and PUBLICATION_READY",
      "phase": "bootstrap",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue370_pr390_containment.readbacks",
      "command": "read back PR390 base head draft open merge, expected head, unpublished local head, and failed second push TLS unexpected eof facts without mutation",
      "phase": "observation",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue370_pr390_containment.external_push",
      "command": "after local validation, perform exactly one normal push of this external containment authority branch and create no PR",
      "phase": "external_authority_publication",
      "required": true,
      "expected_exit_codes": [
        0
      ],
    ...
    {
      "command_id": "issue370_pr390_containment.close_pr",
      "command": "after readback, close PR390 unmerged exactly once; do not comment, mark Ready, merge, or close Issue370",
      "phase": "containment",
      "required": true,
      "expected_exit_codes": [
        0
  ...
  "containment_actions": [
    "readbacks",
    "one normal push of this external authority branch with no PR",
    "close PR390 unmerged exactly once"
  ],
  ...
  "local_unpublished_head_sha": "8475f04757909d3a2f834f462ec6fa3ea3590482",
  "expected_pr_state": "OPEN_DRAFT",
  "attestation_present": false,
  "failed_push_attempt": 2,
  "failed_push_transport": "TLS",
  "failed_push_error": "unexpected eof"
}
```
