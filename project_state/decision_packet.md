...
{
  "schema_version": 1,
  "decision_id": "decision_20260908_issue585_desktop0_tauri_r2_v5",
  "round_id": "round_20260908_issue585_desktop0_tauri_r2_v5",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "decision_scope": "FRESH_MAIN_DESKTOP0_TAURI_NATIVE_STARTUP_BRIDGE_R2_V5",
  ...
  "previous_audit_outcome": "R2_V2_PREAUTHORIZED_AND_IMPLEMENTED_LOCALLY_THEN_FAIL_CLOSED_BECAUSE_FRONTEND_PACKAGE_JSON_WAS_SIMULTANEOUSLY_MUTABLE_AND_REFERENCE_READ_ONLY;R2_V3_ISSUE600_PR609_HISTORICAL_PRODUCT_HEAD_FB4D54D7_READ_ONLY_EVIDENCE_ONLY_NO_REUSE_NO_CHERRY_PICK;R2_V4_FAILED_CLOSED_BEFORE_PRODUCT_MUTATION_BECAUSE_CURRENT_COMMAND_AUTHORITY_REJECTED_LEGACY_LOCAL_EXECUTION_SURFACE",
  "workstream_id": "issue585-desktop0-tauri-native-startup-bridge-r2-v5",
  "source_issue": 585,
  "parent_issue": 357,
  ...
  "required_branch": "owner/desktop0-tauri-r2-v5",
  ...
  "v4_terminal_evidence": {
    "decision_commit": "e11735f3",
  ...
  "fresh_worktree_contract": {
    ...
    "source_ref": "origin/owner/desktop0-tauri-r2-v5",
    "target_branch": "owner/desktop0-tauri-r2-v5",
  ...
  "bootstrap_exception_commands": [
    "bounded read-only fetch of dddd2024/Nerelan to execute repository-owned local gate commands in the isolated owner/desktop0-tauri-r2-v5 checkout",
  ...
  "allowed_commands": [
    {
      "command_id": "issue585_desktop0_v5.bootstrap_and_preflight",
      "command": "verify exact fresh locked main 5df08a23dbaa0e816f081b460ee6e2642004a2b1 and fresh isolated worktree branch owner/desktop0-tauri-r2-v5 merge-base; commit this immutable R2 Decision as the unique first commit; run startup-snapshot, transition-command-plan, transition-lint, transition-preflight --mode pre and worktree-publication-readiness; require PRE_EXECUTION_AUTHORIZED and PUBLICATION_READY before any dependency or product mutation",
      "phase": "bootstrap",
      "required": true,
    ...
    {
      "command_id": "issue585_desktop0_v5.materialize_tauri_dependencies",
    ...
    {
      "command_id": "issue585_desktop0_v5.materialize_tauri_shell",
    ...
    {
      "command_id": "issue585_desktop0_v5.rust_toolchain_if_missing",
    ...
    {
      "command_id": "issue585_desktop0_v5.validate",
    ...
    {
      "command_id": "issue585_desktop0_v5.publish",
      "command": "after all blocking validation passes push the exact branch owner/desktop0-tauri-r2-v5 to locked main 5df08a23dbaa0e816f081b460ee6e2642004a2b1 and create exactly one Draft PR titled R2 v5: DESKTOP-0 Tauri native startup bridge (#585) with body recording the immutable R2 authority snapshot including Decision ID Round ID base SHA Decision commit SHA generated-governance commit SHA semantic commit SHA exact head SHA v4 e11735f3 terminal local negative authority evidence only and PR609 fb4d54d7 historical semantic evidence only plus changed paths dependency versions deterministic check results provider calls 0 credential access 0 browser execution 0 workflow mutation 0 READY NO MERGE NO; never mark Ready and never merge under this Decision",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
    ...
    {
      "command_id": "issue585_desktop0_v5.exact_head_acceptance",
  ...
  "run_environment_binding": {
    ...
    "canonical_repository": "dddd2024/Nerelan",
    "target_owner_branch": "owner/desktop0-tauri-r2-v5",
