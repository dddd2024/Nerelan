...
{
  "schema_version": 1,
  "decision_id": "decision_20260912_issue838_visible_goal_evidence_r3_v5",
  "round_id": "round_20260912_issue838_visible_goal_evidence_r3_v5",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "source_issue_body_sha256": "b5334978e5081c84b23f0270776528279ca98e055590ce7680bbbfaaf006eb3f",
  ...
  "required_branch": "codex/f03-visible-goal-evidence-r3-v5",
  ...
  "allowed_commands": [
    {
      "command_id": "issue838.bootstrap",
      "command": "Observe main exactly1b87cb41606bfbda0b4b49dd18259550fbf5bb58, accepted PR827 native receipt/main CI and fresh clean branchcodex/f03-visible-goal-evidence-r3-v5; commit this immutable APPROVED R3 Decision alone as the first activation commit. Run existing startup-snapshot, transition-command-plan, transition-lint, transition-preflight --mode pre and worktree-publication-readiness. Require PRE_EXECUTION_AUTHORIZED and PUBLICATION_READY before product mutation or any browser/server launch. Do not copy prior Decision/gates/history.",
      "phase": "bootstrap",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue838.implement",
      "command": "Implement only the18 named frontend/test/docs paths in Issue838. After fresh Decision-only activation and passing existing gates, reuse only the17 frozen Issue837 product files after exact SHA256 and unchanged base-blob checks. Preserve all stopped833/834/835/837 and PR819. Keep the current Goal proof, exact Run links, review/publication/remote distinctions, truthful approval/Roadmap labels, restored base-layer reset/focus outline and readable Run state/liveness token styles. In Home Recent goals, use the existing goalStatusLabel for COMPLETED only; preserve every other status string, colors, list cap/order and selection. Add scoped platform-home assertions that completed Recent goals say execution completed/pending review and never raw COMPLETED or functional/delivery success; exercise the response update. Extend the real-browser Recent goals checks and captures under the existing bounds. No new component, verifier, store, backend/workflow/dependency/schema/validator or snapshot change. Reuse installed ignored dependency junction only after manifest/lock verification. No old Decision/gates/history or result is authority/acceptance.",
    ...
    {
      "command_id": "issue838.publish",
      "command": "After all exact-head local and real browser checks pass, push onlycodex/f03-visible-goal-evidence-r3-v5 todddd2024/Nerelan and create exactly one Draft against main@1b87cb41606bfbda0b4b49dd18259550fbf5bb58. One successful push and one successful Draft only; at most3 transport attempts overall, only after readback confirms no mutation. After successful push no further push. Publish disclosed review/evidence and bounded progress comments only to Issue838, its exact Draft,653 and659. Do not mutate other branches/Issues/PRs or repeat completed826 closure.",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [
        0
  ...
  "run_environment_binding": {
    ...
    "target_owner_branch": "codex/f03-visible-goal-evidence-r3-v5",
