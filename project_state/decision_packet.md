...
{
  "schema_version": 1,
  "decision_id": "decision_20260827_issue367_pr382_owner_landing_r2_v1",
  "round_id": "round_20260827_issue367_pr382_owner_landing_r2_v1",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "previous_audit_outcome": "PR382_EXACT_HEAD_ACCEPTED_BY_INDEPENDENT_LUNA_AND_RULESET21023698_STRICT_TRUE_READY_FOR_OWNER_LANDING",
  "workstream_id": "issue367-pr382-owner-landing-r2-v1",
  "source_issue": 367,
  "parent_issue": 365,
  ...
  "required_branch": "owner/issue367-pr382-owner-landing-r2-v1",
  "risk_tier": "R2",
  ...
  "allowed_commands": [
    {
      "command_id": "issue367_pr382_landing.bootstrap",
    ...
    {
      "command_id": "issue367_pr382_landing.observe",
      "command": "immediately re-observe main, PR382 OPEN Draft head/base/mergeability/auto-merge, zero unresolved threads, exact three workflow runs, active schema-v3 intent and digests, Ruleset21023698 active strict merge-only baseline/state-gate policy, independent audit acceptance, and attestation expiry margin; stop on any drift",
    ...
    {
      "command_id": "issue367_pr382_landing.audit_comment",
      "command": "create exactly one PR382 independent exact-head audit comment binding accepted head/base, independent Luna ACCEPTED_EXACT_HEAD, Decision/Plan/intent digests and exact workflow runs; state that it grants no merge authority; read back exact comment id/author/body and do not retry an unknown result",
    ...
    {
      "command_id": "issue367_pr382_landing.attestation",
      "command": "create exactly one inert PR382 placeholder comment containing nonce pr382-owner-attestation-placeholder-v1-cfc2eea1 and no attestation marker; read back its numeric comment id; compute canonical approval and attestation digests; edit that same comment exactly once into the unique active schema-v3 MAINLINE_MERGE_APPROVAL_ATTESTATION bound to PR382/head/base/intent/workflow runs/owner and expiry 2026-08-27T02:48:01Z; read back and require canonical premerge validation PASS; reserve one additional edit only to revoke/remove marker if landing stops before merge",
    ...
    {
      "command_id": "issue367_pr382_landing.ready",
      "command": "re-observe every bound fact and expiry margin, then mark PR382 Ready exactly once; require a new ready_for_review State Gate pull_request run on exact head attempt1 SUCCESS; on failure do not merge and use at most one convert-to-draft plus reserved attestation revocation edit",
      "phase": "ready_gate",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue367_pr382_landing.merge",
      "command": "immediately before merge require main still locked base, PR382 OPEN non-Draft exact head/base MERGEABLE/CLEAN, auto-merge disabled, baseline and Decision Preflight exact-head SUCCESS, fresh Ready State Gate SUCCESS, zero unresolved threads, strict Ruleset unchanged, unique active attestation unchanged and unexpired; perform exactly one owner expected-head merge with method merge and sha cfc2eea13943c7c1597bddd6f8057fd5036a6a84; unknown result is resolved read-only and never retried",
      "phase": "owner_merge",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue367_pr382_landing.postmerge",
      "command": "verify merged_by owner, new main equals merge commit, ordered parents locked base and accepted head, merge tree equals 2e99d9c3baf060e023255cbd27e30b1639964e48, fresh State Gate push attempt1 SUCCESS and canonical mainline validation 46 checks zero failed with receipt EMITTED; only then create exactly one non-marker PR receipt comment and read it back",
    ...
    {
      "command_id": "issue367_pr382_landing.close_issue",
  ...
  "bound_head_sha": "cfc2eea13943c7c1597bddd6f8057fd5036a6a84",
  "bound_merge_method": "merge",
  "bound_merge_tree_sha": "2e99d9c3baf060e023255cbd27e30b1639964e48",
  ...
  "bound_workflow_runs": [
    {
      ...
      "event": "pull_request",
      "run_attempt": 1,
      "head_sha": "cfc2eea13943c7c1597bddd6f8057fd5036a6a84",
      "conclusion": "success"
    },
    {
  ...
  "bound_intent_id": "pr382_issue367_engineering_landing_boundary_r2_v7",
  "bound_intent_digest": "sha256:fcdf1d86d5b8478fec755f3041de7fc1440118538b305702c558efaa349e1517",
  "bound_decision_digest": "8ac11b4dab91f910854c64841cfddd998b9e28bd6e072c122fdd149793389f44",
  "bound_command_plan_digest": "76878067fb19b527439d49b589c801b172ceb8011d602d8e945125fa6684616e",
  "bound_approval_payload_digest": "sha256:3aaf87b8a624f159135c36807840907dec355e21e2639eb0d461cc8cbc486125",
  "attestation_id": "attestation_pr382_issue367_owner_landing_v1",
  "attestation_expires_at": "2026-08-27T02:48:01Z",
  "attestation_placeholder_nonce": "pr382-owner-attestation-placeholder-v1-cfc2eea1",
