...
{
  "schema_version": 1,
  "decision_id": "decision_20260824_issue325_landing_candidate_r2_v6",
  "round_id": "round_20260824_issue325_landing_candidate_r2_v6",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "follows_last_decision_id": "decision_20260824_issue325_landing_candidate_r2_v5",
  "follows_last_round_id": "round_20260824_issue325_landing_candidate_r2_v5",
  "previous_audit_outcome": "ISSUE325_R2_V5_BLOCKED_PATH_RISK_FLOOR_ENFORCED_UNAUTHORIZED_GATE_PATHS",
  "workstream_id": "issue325-landing-candidate-r2-v6",
  "source_issue": 325,
  ...
  "required_branch": "owner/issue325-decision-immutability-landing-r2-v6",
  "risk_tier": "R2",
  ...
  "allowed_commands": [
    {
      "command_id": "issue325_v5.bootstrap",
    ...
    {
      "command_id": "issue325_v5.replay",
      "command": "with apply_patch replay only the six accepted PR337 implementation paths and require committed blob equality; create one replay commit",
    ...
    {
      "command_id": "issue325_v5.validate_and_publish",
    ...
    {
      "command_id": "issue325_v5.bind_intent",
    ...
    {
      "command_id": "issue325_v5.final_push_and_audit",
  ...
  "success_terminal": "ISSUE325_V6_BOUND_DRAFT_ACCEPTED_FOR_SEPARATE_LANDING_DECISION",
  "blocked_terminal": "ISSUE325_V6_BLOCKED_WITH_EXACT_EVIDENCE"
}
```
...
2. One replay commit changes six paths and each blob equals accepted PR337.
...
- Use `apply_patch`; do not cherry-pick or import the dirty v5 worktree.
