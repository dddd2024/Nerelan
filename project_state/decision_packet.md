# Decision Packet — #721 safe base refresh real Ready route current-main v8

```json decision_meta
{
  "schema_version": 1,
  "decision_id": "decision_20260918_issue721_safe_base_refresh_r2_v8_current",
  "round_id": "round_20260918_issue721_safe_base_refresh_r2_v8_current",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "decision_scope": "SAFE_BASE_REFRESH_REAL_READY_ROUTE_AND_LIVE_MAIN_R2_V8",
  "follows_last_decision_id": "decision_20260918_issue721_safe_base_refresh_r2_v7",
  "follows_last_round_id": "round_20260918_issue721_safe_base_refresh_r2_v7",
  "previous_audit_outcome": "V6_PR946_CLOSED_REVIEW_NEGATIVE_SAFE_REFRESH_UNREACHABLE_BEFORE_PROJECT_GATE_BASE_MISMATCH;V7_LOCAL_PREEXECUTION_AUTHORIZED_BUT_IMMUTABLE_TWO_FILE_SCOPE_FORBIDS_REQUIRED_PROJECT_GATE_AND_REMOTE_VERIFIER_COUPLING;NO_V7_SEMANTIC_COMMIT_OR_PUBLICATION",
  "workstream_id": "issue721-safe-base-refresh-r2-v8-current",
  "source_issue": 721,
  "parent_issue": 156,
  ...
  "required_branch": "owner/issue721-safe-base-refresh-r2-v8-current",
  ...
  "semantic_implementation_contract": {
    ...
    "execution_surface_note": "Decision/source/test/commit run only in this clean isolated trusted_worker checkout. Generated gate files are ephemeral with zero commit budget. Remote commit graph/ref/Draft publication is github_control_plane only; local git push is forbidden. Remote verifier change reuses the existing urllib REST transport and Python stdlib only.",
    "completion_boundary": "One immutable Decision commit plus one semantic commit and one Draft PR. No generated-governance commit, Ready, Merge, rerun, dispatch, rebase or history rewrite."
  },
  ...
  "allowed_commands": [
    {
      "command_id": "issue721v8.bootstrap",
    ...
    {
      "command_id": "issue721v8.implement",
      "command": "After PRE_EXECUTION_AUTHORIZED rematerialize the validated v6 safe-refresh core in mainline_landing/test_mainline_landing, then add only the minimum project_gate/live-ref routing required to make refresh reachable while preserving #891 ordinary/formal role split. Add verifier ref-SHA check over the existing REST transport and production-route regressions in test_project_gate. No cherry-pick/rebase/history reuse. Commit exactly once.",
    ...
    {
      "command_id": "issue721v8.validate",
    ...
    {
      "command_id": "issue721v8.publish",
      "command": "Through github_control_plane only create the exact Decision then semantic commit graph, branch owner/issue721-safe-base-refresh-r2-v8-current, and one Draft PR against main@ef8bb6959ac37301c880e0971a97a9d56e9c99a9. No local git push, Ready or Merge.",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [
        0
  ...
  "capability_policy": {
    ...
    "github_control_plane_network_exceptions": [
      "Create only the v8 Decision/semantic commit graph and branch owner/issue721-safe-base-refresh-r2-v8-current in dddd2024/Nerelan, then one Draft PR against main@ef8bb6959ac37301c880e0971a97a9d56e9c99a9; comment only on Issue721/156 and that Draft; never Ready/Merge."
    ]
  },
  "path_risk_floor": [
    {
  ...
  "approval_basis": "User delegated Owner execution and trusted-worker access. Fresh Owner audit of PR946 proved the safe-refresh core is correct but unreachable because project_gate hard-rejects event_base drift first. V7 then proved its immutable two-file scope cannot legally repair that coupling. V8 freezes the minimum real production route plus a thin live-main ref verifier while preserving #891 role separation.",
  "supersedes_decision_id": "decision_20260918_issue721_safe_base_refresh_r2_v7",
  "superseded_evidence": "V7 Decision 8e66beadd0a628ec0732af1da3e2a636cd3f7943 reached PRE_EXECUTION_AUTHORIZED/PUBLICATION_READY but had no semantic commit or publication; scope-insufficient evidence only. PR946/v6 remains closed review-negative core evidence."
}
```
