...
{
  "schema_version": 1,
  "decision_id": "decision_20260819_issue250_ci_repair_r2_v5",
  "round_id": "round_20260819_issue250_ci_repair_r2_v5",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "follows_last_decision_id": "decision_20260819_issue250_ci_repair_r2_v4",
  "follows_last_round_id": "round_20260819_issue250_ci_repair_r2_v4",
  "previous_audit_outcome": "ISSUE250_V4_STATE_GATE_BLOCKED_BY_UNCOMMITTED_ACTIVE_COMMAND_PLAN",
  "workstream_id": "issue250-ci-repair-r2-v5",
  "source_issue": 250,
  "superseded_pr": 254,
  "required_branch": "owner/issue250-platform-completion-v5",
  ...
  "authority_and_product_worktree": "F:/reverse-agent-issue250-platform-completion-v5",
  "risk_tier": "R2",
  ...
  "bootstrap_exception_commands": [
    "git worktree add -b owner/issue250-platform-completion-v5 F:/reverse-agent-issue250-platform-completion-v5 706991ad0cb826d7c963a8ddfb7e770e97cdf60b",
  ...
  "allowed_commands": [
    {
      "command_id": "issue250v5.verify_exact_state",
      "command": "verify origin/main equals 706991ad0cb826d7c963a8ddfb7e770e97cdf60b, PR 254 exact head equals 58f1d2388b1d6393213a3640b10e91f4d95440fd, and record all exact-head CI conclusions",
      "phase": "validation",
      "required": true,
    ...
    {
      "command_id": "issue250v5.bind_active_command_plan",
    ...
    {
      "command_id": "issue250v5.reuse_exact_product_commits",
    ...
    {
      "command_id": "issue250v5.install_frontend_lockfile",
    ...
    {
      "command_id": "issue250v5.frontend_validation",
    ...
    {
      "command_id": "issue250v5.backend_validation",
    ...
    {
      "command_id": "issue250v5.platform_validation",
      "command": "run the Issue 250 Platform blocking suite with the seven provider or historical-decision tests deselected exactly as in v4",
      "phase": "validation",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue250v5.repository_validation",
    ...
    {
      "command_id": "issue250v5.push_once",
      "command": "git push origin HEAD:refs/heads/owner/issue250-platform-completion-v5",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue250v5.replace_draft_pr",
      "command": "close PR 254 as superseded, create one Draft PR from owner/issue250-platform-completion-v5 to main, and comment Issue 250",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
  ...
  "success_terminal": "ISSUE250_V5_REPLACEMENT_DRAFT_PR_EXACT_HEAD_CI_READY",
  "blocked_terminal": "ISSUE250_V5_BLOCKED_WITH_EXACT_EVIDENCE"
}
```

## Goal

Publish the already verified Issue 250 Platform V2 product with its deterministic active Command Plan committed so remote transition lint, Decision Preflight, State Gate, and product CI can validate the same exact authority projection.
...
3. Local frontend, backend, Platform, repository, freshness, transition and diff checks pass on the final exact head.
4. One normal push publishes the branch; PR #254 is closed as superseded and exactly one replacement Draft PR is created.
5. Replacement exact-head GitHub Actions reach SUCCESS with no ready, merge, provider/model call, deployment, release or cleanup.
