...
{
  "schema_version": 1,
  "decision_id": "decision_20260824_issue325_path_b_decision_immutability_r2_v2",
  "round_id": "round_20260824_issue325_path_b_decision_immutability_r2_v2",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "previous_audit_outcome": "PR331_RECOVERY_LANDED_MAIN_PUSH_32682663868_STATE_GATE_PUSH_32682663872",
  "workstream_id": "issue325-path-b-decision-immutability-r2-v2",
  "source_issue": 325,
  "parent_issue": 321,
  ...
  "required_branch": "owner/issue325-path-b-decision-immutability-r2-v2",
  "risk_tier": "R2",
  ...
  "allowed_commands": [
    ...
    },
    {
      ...
      "command": "extend the existing project_gate path only: enforce decision_content_immutable_after_activation=true with live git history and committed blob evidence in transition_preflight, transition_reconcile and worktree_publication_readiness; remove only the three DecisionImmutability CI deselections; add fail-closed regression tests; create exactly one implementation commit",
    ...
    },
    {
      ...
      "command": "after complete deterministic validation, perform exactly one normal fast-forward push of owner/issue325-path-b-decision-immutability-r2-v2, create exactly one Draft PR against main at 122f91ff451929f34cd71e918d88f1512d020d1d, observe exact-head CI State Gate and Decision Preflight checks read-only, then stop at independent audit",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
  ...
  "success_terminal": "ISSUE325_DECISION_IMMUTABILITY_ENFORCED_DRAFT_PR_READY_FOR_INDEPENDENT_AUDIT",
