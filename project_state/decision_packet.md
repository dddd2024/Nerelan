...
{
  "schema_version": 1,
  "decision_id": "decision_20260824_issue332_pr331_attested_landing_r2_v1",
  "round_id": "round_20260824_issue332_pr331_attested_landing_r2_v1",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "previous_audit_outcome": "PR331_EXACT_HEAD_ACCEPTED_FOR_PRE_ATTESTED_EXPECTED_HEAD_LANDING",
  "workstream_id": "issue332-pr331-attested-landing-r2-v1",
  "source_issue": 332,
  "parent_issue": 330,
  "candidate_pr": 331,
  ...
  "required_branch": "owner/issue332-pr331-landing-r2-v1",
  "risk_tier": "R2",
  ...
  "deployment_limit": 0,
  "accepted_exact_head_sha": "6d37e3ec7ca35da95c83b0bc03f1e6be2321950e",
  "required_premerge_runs": [
    {"name": "CI", "run_id": 32680416619, "run_attempt": 1, "conclusion": "success", "event": "pull_request", "workflow_file": ".github/workflows/ci.yml", "head_sha": "6d37e3ec7ca35da95c83b0bc03f1e6be2321950e"},
    {"name": "Decision Preflight", "run_id": 32680416560, "run_attempt": 1, "conclusion": "success", "event": "pull_request", "workflow_file": ".github/workflows/decision-preflight.yml", "head_sha": "6d37e3ec7ca35da95c83b0bc03f1e6be2321950e"},
    {"name": "State Gate (pull_request)", "run_id": 32680416585, "run_attempt": 1, "conclusion": "success", "event": "pull_request", "workflow_file": ".github/workflows/state-gate.yml", "head_sha": "6d37e3ec7ca35da95c83b0bc03f1e6be2321950e"}
  ],
  "active_intent_blob_sha256": "dfb46422678db38e53cadd94c0f4b9dc43676dc78a547e246b4cbebea82f1145",
  ...
  "premerge_attestation_policy": {
    ...
    "comment_scope": "PR331 carrying comment only",
  ...
  "bootstrap_exception_commands": [
    "reobserve origin/main, PR331 exact base/head, Draft/CLEAN/MERGEABLE state, three attempt-1 successful runs, zero comments/reviews/threads and no target branch collision",
  ...
  "allowed_commands": [
    {
      "command_id": "issue332.bootstrap_and_preflight",
    ...
    {
      "command_id": "issue332.premerge_remote_attestation",
      "command": "after fresh exact-head observation and independent audit, create exactly one placeholder comment on PR331, update that same comment exactly once with the final schema-v2 attestation, read back its immutable id/body/created_at/updated_at, and require exact PR/base/head/active intent/run bindings and timestamps strictly before merge",
      "phase": "remote_landing",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "remote",
      "operations": ["create_one_pr331_placeholder_comment", "update_same_pr331_comment_once", "readback_remote_comment"],
      "network_access": true,
      "required_evidence_source": "repository_state_attestation",
      "allowed_remote_scope": "PR331 carrying attestation comment only"
    },
    {
      "command_id": "issue332.expected_head_merge",
      "command": "after successful attestation readback and immediate re-observation, mark PR331 ready exactly once and immediately merge with merge method and exact expected-head protection; verify merged=true, first parent=locked base, second parent=accepted head, merge tree=accepted-head tree and new main equals returned merge commit",
      "phase": "remote_landing",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "remote",
      ...
      "network_access": true,
      "required_evidence_source": "repository_state_attestation",
      "allowed_remote_scope": "PR331 only"
    },
    {
      "command_id": "issue332.post_merge_observation",
  ...
  "capability_policy": {
    ...
    "github_pr_comment_scope": "PR331 carrying attestation only",
  ...
  "success_terminal": "PR331_PREMERGE_REMOTE_ATTESTATION_VALID_EXPECTED_HEAD_MERGE_COMPLETE_EXACT_NEW_MAIN_CI_AND_STATE_GATE_SUCCESS",
  "blocked_terminal": "ISSUE332_PR331_ATTESTED_LANDING_BLOCKED_WITH_EXACT_EVIDENCE"
}
```

## Goal

Perform one non-retroactive, pre-attested, expected-head-protected landing of PR #331. The accepted candidate is exactly PR331 head `6d37e3ec7ca35da95c83b0bc03f1e6be2321950e` against `main@0beac2f57c1ae9caa1b11dc02dfc027c9b19e496`. The landing authority branch changes only Decision and generated governance artifacts; the product branch and PR head are immutable.

## Acceptance

1. Immediately before remote mutation, PR331 is OPEN, Draft, CLEAN and MERGEABLE; base is exact locked main; head is exact accepted head; target landing branch has no collision; no comments, reviews, unresolved threads or blocking review decision exist.
2. The exact pre-merge runs are attempt 1 SUCCESS: CI `32680416619`, Decision Preflight `32680416560`, State Gate (pull_request) `32680416585`, all bound to accepted head `6d37e3ec...`.
3. Active schema-v2 intent is read back and binds PR331, exact base, the Issue330 Decision/Command Plan digests, three required workflows and bounded expiry; its recorded blob SHA-256 is `dfb46422678db38e53cadd94c0f4b9dc43676dc78a547e246b4cbebea82f1145`.
4. The carrying comment lifecycle consists of exactly one placeholder creation and exactly one update of that same comment. The final attestation binds PR331, exact base/head, merge method, active-intent digest, exact successful runs, owner `dddd2024`, approval object id equal to the comment id and canonical digests.
...
10. No product/source/test/workflow/intent mutation, authority branch push, extra comment, unrelated issue/PR mutation, provider/model call, credential access, dependency install, offensive-security work, tag, release, deployment, force push, rebase, reset, amend, mark-ready outside PR331 or merge outside PR331 occurs.

## Execution policy

- This immutable Decision is the only Path-B authority for the landing round; Issue #332 is the owner plan but does not itself authorize mutation.
...
- The PR331 comment is the only permitted remote comment. Create one placeholder, update the same object once, read it back, and never edit it after merge.
...
- Mark-ready and merge are explicitly authorized only for PR331 in this exact expected-head sequence. Owner attestation, automatic merge, direct main push and all unrelated publication remain forbidden.
