...
```json decision_contract
{
  ...
  "previous_audit_outcome": "CONTROL_H_READY_CLEAN_AT_B_ISSUE370_CURRENT_BASE_FRESHNESS_ADVANCE",
  "workstream_id": "issue370-strict-freshness-advance-r2-v3",
  "source_issue": 370,
  "parent_issue": 367,
  ...
  "required_branch": "owner/issue370-strict-freshness-advance-r2-v3",
  "risk_tier": "R2",
  ...
  "allowed_commands": [
    {
      "command_id": "issue370_r2v3.bootstrap_governance",
    ...
    {
      "command_id": "issue370_r2v3.publish_governed_draft",
      "command": "after local gates pass, push the exact named branch at most three times, create exactly one governed Draft PR against main at locked base B, and update its body at most twice; keep the PR Draft and do not comment, mark ready, merge, or close Issue #370",
      "phase": "publication",
      "required": false,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue370_r2v3.bind_schema3_intent",
      "command": "after the actual Draft PR number exists, archive the inherited PR382 v7 intent byte-for-byte and bind active.json exactly once to the actual PR with schema 3, current Decision and command-plan digests, locked base B, baseline workflows, merge method merge, equal_to_accepted_head_tree, and bounded expiry 2026-09-04T23:59:59Z",
  ...
  "github_ruleset_mutation_attempt_limit": 0,
  ...
  "deterministic_stale_pr_scenario_required_before_issue_close": false,
