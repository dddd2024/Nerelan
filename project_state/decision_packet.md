# Approved bounded PR961 delegated Owner landing v2

```json decision_meta
{
  "schema_version": 1,
  "decision_id": "decision_20260919_issue659_pr961_owner_landing_r2_v2",
  "round_id": "round_20260919_issue659_pr961_owner_landing_r2_v2",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "superseded_evidence": "Prior source PRs949/952/954/957/959/960 supplied reviewed content to target961; those authorities do not authorize this landing. Failed predecessor958 is preserved. No old authority branch/Decision is reused. Local unpublished landing v1 a42f168ebff1a3fd649964c0067505653844ca20 stopped at command-plan surface incompatibility before publication; retain unchanged as negative evidence. v2 splits read-only postmerge observation from GitHub closure writes using existing operation registry.",
  "risk_tier": "R2",
  ...
  "required_branch": "codex/pr961-owner-landing-r2-v2-20260919",
  "workstream_id": "issue659-pr961-owner-landing-r2-v2",
  ...
  "capability_policy": {
    ...
    "github_control_plane_network_exceptions": [
      "Publish only the Decision commit graph/ref codex/pr961-owner-landing-r2-v2-20260919 and one Draft sidecar against locked main. Keep sidecar Draft/unmerged; no local git push.",
  ...
  "allowed_commands": [
    {
      "command_id": "issue659landingv2.bootstrap",
      "command": "Use fresh F:/Nerelan-pr961-owner-landing-v2 at locked main; commit only Decision, then startup-snapshot/transition-command-plan/transition-lint/transition-preflight --mode pre and worktree-publication-readiness. Run provider-free tests/test_control_plane_transition.py and tests/test_decision_preflight.py, git diff --check. Generated gate files never committed.",
      "phase": "bootstrap",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue659landingv2.publish",
    ...
    {
      "command_id": "issue659landingv2.validate",
    ...
    {
      "command_id": "issue659landingv2.attest",
    ...
    {
      "command_id": "issue659landingv2.land_target",
    ...
    {
      "command_id": "issue659landingv2.observe",
      "command": "Read exact postmerge main/merge/parents and natural StateGate, per-Issue acceptance and unchanged superseded Draft heads. Record factual proof outside repository; no writes through this observation surface.",
      "phase": "final_evidence",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue659landingv2.close_completed",
      "command": "Only after verified postmerge success and per-Issue acceptance, comment and close explicitly allowed completed source Issues and unchanged superseded Drafts. Preserve broad roadmaps,721 checkout and refs.",
      "phase": "final_evidence",
      "required": true,
      "expected_exit_codes": [
        0
