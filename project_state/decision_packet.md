...
{
  "schema_version": 1,
  "decision_id": "decision_20260911_issue783_artifact_handoff_r2_v2",
  "round_id": "round_20260911_issue783_artifact_handoff_r2_v2",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "source_issue_body_sha256": "4af0da82edcf7d45cef7423f912de3c5a8fde85ba3970c522354d44e4455a6dd",
  ...
  "required_branch": "codex/f02-accepted-artifact-handoff-r2-v2",
  ...
  "capability_policy": {
    ...
    "github_control_plane_network_exceptions": [
      "After blocking checks pass, push only codex/f02-accepted-artifact-handoff-r2-v2 and create/update one Draft PR in dddd2024/Nerelan against main at 6c41aae9b9e148c658d3f9dece9ba71338e82611; publish disclosed audit/evidence and Issue 783/652/659 progress comments; no other branch or repository publication.",
  ...
  "allowed_commands": [
    ...
    {
      "command_id": "issue783.implement",
      "command": "After fresh activation/preflight, copy only the five hash-bound product candidate files from preserved stopped Issue782 as specified in Issue783, never old Decision/gates/commits. Repair the missing json import in run_store.py with assertions preserved. Implement the complete F02 explicit accepted-artifact input contract and exactly twenty-six source/frontend/test/documentation paths in Issue783. Reuse existing Git object/private-index/worktree preparation, TaskStore evidence/lease/checkpoints and all ordinary/durable single/team execution and recovery paths. Preserve frozen approved base separately from exact producer input commit/tree. Include validation-only immutability, UI selection/review and safe consumed-input evidence. Bounded local retention refs/nerelan/accepted-artifacts/<task-id>/<execution-id> use create-if-absent with identical-binding idempotence only, no remote publication or arbitrary ref mutation. No second database, runner, coordinator or Gate; no workflow/dependency/provider/credential/browser/reverse-tool change.",
    ...
    {
      "command_id": "issue783.publish",
      "command": "After blocking checks pass, push only codex/f02-accepted-artifact-handoff-r2-v2 and create/update one Draft PR in dddd2024/Nerelan against main at 6c41aae9b9e148c658d3f9dece9ba71338e82611; publish disclosed audit/evidence and Issue 783/652/659 progress comments; no other branch or repository publication.",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [
        0
