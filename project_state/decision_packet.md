...
{
  "schema_version": 1,
  "decision_id": "decision_20260822_issue285_home_goal_truth_r2_v1_landing",
  "round_id": "round_20260822_issue285_home_goal_truth_r2_v1_landing",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "previous_audit_outcome": "PR286_EXACT_HEAD_8310A25_ACCEPTED_REVIEW_4998754580_CI_32547032914_MODEL_ACCESS_32547032884_SUCCESS_PENDING_SEPARATE_LANDING_AUTHORITY",
  "workstream_id": "issue285-home-goal-truth-r2-v1-landing",
  "source_issue": 285,
  ...
  "required_branch": "owner/issue285-home-goal-truth-r2-v1-landing",
  ...
  "bootstrap_exception_commands": [
    "create owner/issue285-home-goal-truth-r2-v1-landing from accepted product head 8310a25ae3c2e88e21207434e7d3647a971f8b0f in an isolated canonical-LF checkout whose merge-base with main is ecacfd94e5140151a97fb1d3d486cd992769271b",
  ...
  "allowed_commands": [
    ...
    },
    {
      ...
      "command": "after prepublication validation passes push owner/issue285-home-goal-truth-r2-v1-landing once and create exactly one Draft PR with base main; read the actual GitHub-assigned PR number without guessing; transient checks against inherited PR 277 active intent are not acceptance evidence",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
  ...
  "capability_policy": {
    ...
    "local_network_exceptions": [
      ...
      "after prepublication validation passes push owner/issue285-home-goal-truth-r2-v1-landing once and create exactly one Draft PR with base main; read the actual GitHub-assigned PR number without guessing; transient checks against inherited PR 277 active intent are not acceptance evidence",
  ...
  "success_terminal": "ISSUE285_HOME_GOAL_TRUTH_R2_V1_LANDING_MERGED_MAIN_GREEN_ISSUE_CLOSED",
  "blocked_terminal": "ISSUE285_HOME_GOAL_TRUTH_R2_V1_LANDING_BLOCKED_WITH_EXACT_EVIDENCE"
}
```
...
5. Before the landing PR number exists, only the four exact declared active-intent binding assertions may be additionally deselected. After actual PR binding, all four pass and no other failure is accepted.
