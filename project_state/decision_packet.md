...
```json decision_meta
{"schema_version":1,"decision_id":"decision_20260816_issue215_dogfood1_product_setup_bootstrap_r2_v1","round_id":"round_20260816_issue215_dogfood1_product_setup_bootstrap_r2_v1","status":"APPROVED","mainline":"engineering_branch","skill_profiles":["reverse-agent-iteration@v2"]}
```

```json decision_contract
{
  "transition_kernel_required": true,
  "follows_last_decision_id": "decision_20260816_issue213_dogfood1_zero_model_readiness_r2_v1",
  "follows_last_round_id": "round_20260816_issue213_dogfood1_zero_model_readiness_r2_v1",
  "previous_audit_outcome": "LONG_RUNNING_DOGFOOD1_ZERO_MODEL_READINESS_BLOCKED_PRODUCT_SETUP_STATE_ABSENT",
  "workstream_id": "issue215-dogfood1-product-setup-bootstrap-r2-v1",
  "source_issue": 215,
  "parent_issue": 148,
  "required_branch": "owner/issue215-dogfood1-product-setup-bootstrap-r2-v1",
  ...
  "external_harness_write_path": "F:/reverse-agent-issue215-product-setup-bootstrap-v1/setup_bootstrap.py",
  "external_runtime_write_allowlist": [
    "F:/reverse-agent-issue215-product-setup-bootstrap-v1/**",
  ...
  "credential_boundary": {
    ...
    "credential_file_discovery_allowed": false,
    "environment_name_presence_check_allowed": ["SENSENOVA_API_KEY"],
    "environment_value_read_allowed": false,
    "environment_value_print_allowed": false,
    "environment_value_hash_allowed": false,
    "environment_value_length_check_allowed": false,
    "environment_value_copy_or_export_allowed": false,
  ...
  "capability_policy": {
    ...
    "local_network_exceptions": [
      ...
      "git -C F:/reverse-agent-planning-smoke fetch origin owner/issue215-dogfood1-product-setup-bootstrap-r2-v1"
    ],
  ...
  "bootstrap_exception_commands": [
    ...
    "git -C F:/reverse-agent-planning-smoke rev-parse origin/owner/issue215-dogfood1-product-setup-bootstrap-r2-v1",
    "powershell -NoProfile -Command \"$b=(git -C F:/reverse-agent-planning-smoke branch --list owner/issue215-dogfood1-product-setup-bootstrap-r2-v1);if($b){'ISSUE215_V1_LOCAL_BRANCH_ALREADY_EXISTS';exit 25};if(Test-Path -LiteralPath 'F:/reverse-agent-issue215-dogfood1-product-setup-bootstrap-r2-v1'){'ISSUE215_V1_AUTHORITY_WORKTREE_ALREADY_EXISTS';exit 24};if(Test-Path -LiteralPath 'F:/reverse-agent-issue215-bootstrap-source-v1'){'ISSUE215_V1_SOURCE_WORKTREE_ALREADY_EXISTS';exit 23};if(Test-Path -LiteralPath 'F:/reverse-agent-issue215-product-setup-bootstrap-v1'){'ISSUE215_V1_EVIDENCE_ROOT_ALREADY_EXISTS';exit 22};'ISSUE215_V1_BOOTSTRAP_TARGETS_ABSENT'\"",
    "git -C F:/reverse-agent-planning-smoke worktree add --track -b owner/issue215-dogfood1-product-setup-bootstrap-r2-v1 F:/reverse-agent-issue215-dogfood1-product-setup-bootstrap-r2-v1 origin/owner/issue215-dogfood1-product-setup-bootstrap-r2-v1",
    "Set-Location F:/reverse-agent-issue215-dogfood1-product-setup-bootstrap-r2-v1",
    "git status --short",
    "git rev-parse HEAD",
  ...
  "allowed_commands": [
    {
      "command_id":"issue215v1.source_worktree_create",
      "command":"git -C F:/reverse-agent-planning-smoke worktree add --detach F:/reverse-agent-issue215-bootstrap-source-v1 09ac6ea2fd6fdb46364252407dd73ec136f82ec9",
      "phase":"setup","required":true,"expected_exit_codes":[0],"execution_surface":"local","operations":["worktree_create"],"network_access":false,"required_evidence_source":"local_command_evidence"
    },
    {
      "command_id":"issue215v1.source_head",
      "command":"git -C F:/reverse-agent-issue215-bootstrap-source-v1 rev-parse HEAD",
      "phase":"validation","required":true,"expected_exit_codes":[0],"execution_surface":"local","operations":["repository_observation"],"network_access":false,"required_evidence_source":"local_command_evidence"
    },
    {
      "command_id":"issue215v1.source_status_before",
      "command":"git -C F:/reverse-agent-issue215-bootstrap-source-v1 status --short",
      "phase":"validation","required":true,"expected_exit_codes":[0],"execution_surface":"local","operations":["repository_observation"],"network_access":false,"required_evidence_source":"local_command_evidence"
    },
    {
      "command_id":"issue215v1.evidence_root_create",
      "command":"powershell -NoProfile -Command \"New-Item -ItemType Directory -Path 'F:/reverse-agent-issue215-product-setup-bootstrap-v1' -ErrorAction Stop | Out-Null; 'ISSUE215_V1_EVIDENCE_ROOT_CREATED'\"",
      "phase":"setup","required":true,"expected_exit_codes":[0],"execution_surface":"local","operations":["run_checks"],"network_access":false,"required_evidence_source":"local_command_evidence"
    },
    {
      "command_id":"issue215v1.setup_bootstrap",
      "command":"powershell -NoProfile -Command \"$a=(git -C 'F:/reverse-agent-issue215-dogfood1-product-setup-bootstrap-r2-v1' rev-parse HEAD).Trim(); python 'F:/reverse-agent-issue215-product-setup-bootstrap-v1/setup_bootstrap.py' --source 'F:/reverse-agent-issue215-bootstrap-source-v1' --root 'F:/reverse-agent-issue215-product-setup-bootstrap-v1/runtime' --target 'F:/reverse-agent/.platform_v1_runtime/model_setup_state.json' --authority $a --planning '09ac6ea2fd6fdb46364252407dd73ec136f82ec9'\"",
      "phase":"configuration","required":true,"expected_exit_codes":[0,20],"execution_surface":"local","operations":["run_checks"],"network_access":false,"required_evidence_source":"local_command_evidence"
    },
    {
      "command_id":"issue215v1.source_status_after",
      "command":"git -C F:/reverse-agent-issue215-bootstrap-source-v1 status --short",
      "phase":"validation","required":true,"expected_exit_codes":[0],"execution_surface":"local","operations":["repository_observation"],"network_access":false,"required_evidence_source":"local_command_evidence"
    },
    {
      "command_id":"issue215v1.authority_status_final",
      "command":"git -C F:/reverse-agent-issue215-dogfood1-product-setup-bootstrap-r2-v1 status --short",
...
Create exactly one restart-safe, environment-backed sanitized Product Setup record for SenseNova 6.7 Flash-Lite and prove that the resulting Connection/Binding survives two fresh trusted-host OS process cycles without reading the raw API key, without touching the real TaskStore, and without any model/provider request.

# External harness rule

`F:/reverse-agent-issue215-product-setup-bootstrap-v1/setup_bootstrap.py` is the only external script permitted. It may be created only after transition preflight is `PRE_EXECUTION_AUTHORIZED`, `blocking_reasons=[]`, and `issue215v1.evidence_root_create` succeeds. It must not be added to Git.
