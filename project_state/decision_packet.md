...
{
  "schema_version": 1,
  "decision_id": "decision_20260911_issue774_pr772_owner_landing_r2_v2",
  "round_id": "round_20260911_issue774_pr772_owner_landing_r2_v2",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "target_pr": 772,
  "source_pr": 772,
  "target_branch": "codex/f03-functional-verification-r2",
  "accepted_exact_head_sha": "4780723f4ac124276765cd8c680c36aefe598341",
  ...
  "fresh_base": "18a871839a1019251f9997ad0f5a74b8a4230787",
  "current_main_expected": "18a871839a1019251f9997ad0f5a74b8a4230787",
  "integration_base_ref": "main",
  "required_branch": "codex/pr772-owner-landing-r2-v2",
  "source_issue": 774,
  "parent_issue": 771,
  "trigger_issue": 771,
  "trigger_pr": 772,
  "owner_exact_head_review_id": 5176833412,
  "owner_exact_head_review_commit": "4780723f4ac124276765cd8c680c36aefe598341",
  "target_decision_content_sha256": "41f94f32237f613c5eb63d6c50389a0c2cc5ee493a407204911033e014800a5b",
  "follows_last_decision_id": "decision_20260911_issue771_functional_validation_r2_v1",
  "follows_last_round_id": "round_20260911_issue771_functional_validation_r2_v1",
  "previous_audit_outcome": "PR772_EXACT_HEAD_4780723f4ac124276765cd8c680c36aefe598341_DISCLOSED_CODEX_SELF_AUDIT_ACCEPTED_OWNER_REVIEW_5176833412",
  "workstream_id": "issue774-pr772-owner-landing-r2-v2",
  ...
  "landing_authority_scope_note": "Validation-only / landing-authority-only sidecar v2 for PR #772. This immutable R2 Decision binds target_pr=772, source_pr=772, target_branch=codex/f03-functional-verification-r2, accepted_exact_head_sha=4780723f4ac124276765cd8c680c36aefe598341, base_sha=18a871839a1019251f9997ad0f5a74b8a4230787, integration_base_ref=main. It grants the Owner exactly-once Mark Ready and exactly-one expected-head protected regular merge of PR #772 using merge method merge, only after the natural target Ready-triggered landing-state-gate reports terminal SUCCESS on the unchanged exact target head 4780723f4ac124276765cd8c680c36aefe598341 with contexts baseline=success, state-gate=success, landing-state-gate=success. The sidecar authority PR itself must remain Draft forever and must never be marked Ready or merged. mainline_merge_intent_required=false + active_pr_binding_mode=none is the false/none cutover contract; project_state/mainline_merge_intents/active.json is never read or rewritten and active_json_rewrite is forbidden. No target-branch push, no target semantic mutation, no workflow rerun or dispatch, no runner dispatch, no direct main push, no auto-merge, no force push and no rebase. Publication retry accounting: maximum 3 total push invocations and 2 total PR-create invocations; transport failures consume an attempt; retry only if read-only remote observation proves no remote mutation occurred. Owner actions in this round are explicitly delegated to Codex by the user and must be disclosed as agent actions. No independent human review is claimed.",
  ...
  "owner_landing_bounds": {
    ...
    "allowed_merge_method": "merge",
    "expected_head_protection_required": true,
    "expected_head": "4780723f4ac124276765cd8c680c36aefe598341"
  },
  "required_landing_sequence": [
    "sidecar requires only natural CI, Decision Preflight and State Gate on the exact sidecar head",
    "re-check main == 18a871839a1019251f9997ad0f5a74b8a4230787, target PR #772 head == 4780723f4ac124276765cd8c680c36aefe598341, target PR #772 still OPEN, DRAFT and unmerged",
    "mark target PR #772 Ready exactly once",
    "observe a NEW natural target State Gate triggered by Ready",
    "require unchanged exact target head 4780723f4ac124276765cd8c680c36aefe598341 and contexts baseline=success, state-gate=success, landing-state-gate=success",
    "explicitly reject landing-state-gate-draft-inert as formal landing evidence",
    "publish exactly one pre-merge structured comment OWNER_LANDING_MERGE_ATTESTATION with JSON block owner_landing_merge_attestation on target PR #772",
    "fresh no-drift check",
    "merge target PR #772 exactly once with method=merge and expected head 4780723f4ac124276765cd8c680c36aefe598341"
  ],
  ...
  "allowed_commands": [
    ...
    {
      "command_id": "pr772_owner_landing_r2_v2.validate",
    ...
    {
      "command_id": "pr772_owner_landing_r2_v2.materialize_generated_authority",
      "command": "commit exactly one generated governance commit chore: materialize PR772 landing authority R2 v2 containing only project_state/gates/command_plan.json project_state/gates/transition_command_plan_preview.json and project_state/gates/transition_preflight_result.json; no product semantic commit exists in this sidecar and project_state/gates/bootstrap_state.json is never committed; if another tracked commit is necessary FAIL CLOSED",
    ...
    {
      "command_id": "pr772_owner_landing_r2_v2.natural_authority_validation",
      "command": "require natural exact-head CI, Decision Preflight and State Gate observations on the authority Draft PR head and confirm no main drift from 18a871839a1019251f9997ad0f5a74b8a4230787 and no target head drift from 4780723f4ac124276765cd8c680c36aefe598341 and no concurrent landing authority; keep the authority PR Draft and do NOT mark Ready or merge; the authority grants the Owner exactly-once Mark Ready and exactly-one expected-head protected merge of target PR 772 only after a formal Ready-triggered landing-state-gate success and required exact-head contexts baseline state-gate landing-state-gate",
  ...
  "target_decision_contract": {
    ...
    "content_sha256": "41f94f32237f613c5eb63d6c50389a0c2cc5ee493a407204911033e014800a5b",
    "mainline_merge_intent_required": false,
    "active_pr_binding_mode": "none",
  ...
  "target_acceptance_evidence": {
    ...
    "natural_runs": [
      {
        ...
        "run_number": 1185,
        "conclusion": "success",
        "head_sha": "4780723f4ac124276765cd8c680c36aefe598341"
      },
      {
    ...
    "model_access_expected": "EXPECTED_NO_BY_PATH_FILTER",
    "playwright_expected": "EXPECTED_NO_BY_PATH_FILTER",
    "local_required_tests": "375 passed"
  },
  "run_environment_binding": {
    "run_strategy": "trusted_worker",
    "canonical_repository": "dddd2024/Nerelan",
    "target_owner_branch": "codex/pr772-owner-landing-r2-v2",
    "target_product_branch": "codex/f03-functional-verification-r2",
  ...
  "source_issue_body_sha256": "ee929f682c4f7952d919d4d9dcbd81dcd3594fb73987efc3018f337e3b424c36",
  ...
  "supersedes_blocked_authority_issue": 773,
  "supersedes_blocked_authority_head": "539148c4c803a7253c2bd512ecc59e4a2a791eb4",
  "replacement_reason": "Post-commit read-only preflight rejected the gate-generated bootstrap_state delta because v1 machine scope contradicted its incidental-observation prose. v1 was not published and remains preserved. This fresh Decision authorizes only that existing local generator output while keeping it non-stageable and absent from the four-path committed sidecar."
}
```
