...
{
  "schema_version": 1,
  "decision_id": "decision_20260816_issue220_dogfood1_external_session_bootstrap_r2_v2",
  "round_id": "round_20260816_issue220_dogfood1_external_session_bootstrap_r2_v2",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "follows_last_decision_id": "decision_20260816_issue220_dogfood1_external_session_bootstrap_r2_v1",
  "follows_last_round_id": "round_20260816_issue220_dogfood1_external_session_bootstrap_r2_v1",
  "previous_audit_outcome": "ISSUE220_V1_SUPERSEDED_BEFORE_EXECUTION_CREDENTIAL_SCOPE_AMBIGUITY",
  "workstream_id": "issue220-dogfood1-external-session-bootstrap-r2-v2",
  "source_issue": 220,
  "parent_issue": 148,
  "required_branch": "owner/issue220-dogfood1-external-session-bootstrap-r2-v2",
  ...
  "supersedes_decision_id": "decision_20260816_issue220_dogfood1_external_session_bootstrap_r2_v1",
  "superseded_branch_must_not_execute": "owner/issue220-dogfood1-external-session-bootstrap-r2-v1",
  ...
  "external_harness_write_path": "F:/reverse-agent-issue220-external-session-bootstrap-v2/setup_bootstrap.py",
  "external_runtime_write_allowlist": [
    "F:/reverse-agent-issue220-external-session-bootstrap-v2/**",
  ...
  "credential_boundary": {
    ...
    "agent_or_harness_raw_auth_probe_stdout_access_allowed": false,
    "opencode_internal_auth_store_resolution_for_auth_list_allowed": true,
    "trusted_product_raw_auth_list_stdout_transient_parse_allowed": true,
  ...
  "capability_policy": {
    ...
    "local_network_exceptions": [
      ...
      "git -C F:/reverse-agent-planning-smoke fetch origin owner/issue220-dogfood1-external-session-bootstrap-r2-v2"
    ],
  ...
  "bootstrap_exception_commands": [
    ...
    "git -C F:/reverse-agent-planning-smoke rev-parse origin/owner/issue220-dogfood1-external-session-bootstrap-r2-v2",
    "powershell -NoProfile -Command \"$b=(git -C F:/reverse-agent-planning-smoke branch --list owner/issue220-dogfood1-external-session-bootstrap-r2-v2);if($b){'ISSUE220_V2_LOCAL_BRANCH_ALREADY_EXISTS';exit 25};if(Test-Path -LiteralPath 'F:/reverse-agent-issue220-dogfood1-external-session-bootstrap-r2-v2'){'ISSUE220_V2_AUTHORITY_WORKTREE_ALREADY_EXISTS';exit 24};if(Test-Path -LiteralPath 'F:/reverse-agent-issue220-bootstrap-source-v2'){'ISSUE220_V2_SOURCE_WORKTREE_ALREADY_EXISTS';exit 23};if(Test-Path -LiteralPath 'F:/reverse-agent-issue220-external-session-bootstrap-v2'){'ISSUE220_V2_EVIDENCE_ROOT_ALREADY_EXISTS';exit 22};'ISSUE220_V2_BOOTSTRAP_TARGETS_ABSENT'\"",
    "git -C F:/reverse-agent-planning-smoke worktree add --track -b owner/issue220-dogfood1-external-session-bootstrap-r2-v2 F:/reverse-agent-issue220-dogfood1-external-session-bootstrap-r2-v2 origin/owner/issue220-dogfood1-external-session-bootstrap-r2-v2",
    "Set-Location F:/reverse-agent-issue220-dogfood1-external-session-bootstrap-r2-v2",
    "git status --short",
    "git rev-parse HEAD",
  ...
  "allowed_commands": [
    {
      "command_id": "issue220v2.source_worktree_create",
      "command": "git -C F:/reverse-agent-planning-smoke worktree add --detach F:/reverse-agent-issue220-bootstrap-source-v2 3b650e6239336c796593cecd3c137cf839cf1e95",
      "phase": "setup",
      "required": true,
    ...
    {
      "command_id": "issue220v2.source_head",
      "command": "git -C F:/reverse-agent-issue220-bootstrap-source-v2 rev-parse HEAD",
      "phase": "validation",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue220v2.source_status_before",
      "command": "git -C F:/reverse-agent-issue220-bootstrap-source-v2 status --short",
      "phase": "validation",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue220v2.evidence_root_create",
      "command": "powershell -NoProfile -Command \"New-Item -ItemType Directory -Path 'F:/reverse-agent-issue220-external-session-bootstrap-v2' -ErrorAction Stop | Out-Null; 'ISSUE220_V2_EVIDENCE_ROOT_CREATED'\"",
      "phase": "setup",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue220v2.setup_bootstrap",
      "command": "powershell -NoProfile -Command \"$a=(git -C 'F:/reverse-agent-issue220-dogfood1-external-session-bootstrap-r2-v2' rev-parse HEAD).Trim(); python 'F:/reverse-agent-issue220-external-session-bootstrap-v2/setup_bootstrap.py' --source 'F:/reverse-agent-issue220-bootstrap-source-v2' --root 'F:/reverse-agent-issue220-external-session-bootstrap-v2/runtime' --target 'F:/reverse-agent/.platform_v1_runtime/model_setup_state.json' --authority $a --planning '3b650e6239336c796593cecd3c137cf839cf1e95'\"",
      "phase": "configuration",
      "required": true,
    ...
    {
      "command_id": "issue220v2.source_status_after",
      "command": "git -C F:/reverse-agent-issue220-bootstrap-source-v2 status --short",
      "phase": "validation",
      "required": true,
      "expected_exit_codes": [0],
    ...
    {
      "command_id": "issue220v2.authority_status_final",
      "command": "git -C F:/reverse-agent-issue220-dogfood1-external-session-bootstrap-r2-v2 status --short",
      "phase": "status",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
  ...
  "forbidden_operations": [
    ...
    "agent_or_harness_raw_auth_probe_stdout_access",
...
Create exactly one restart-safe sanitized Product Setup record for SenseNova 6.7 Flash-Lite that reuses the already-persisted OpenCode `sensetime` authentication through the landed external-session path, prove the exact record in two fresh trusted-host OS processes before durable installation, and perform zero model/provider execution and zero Agent/harness raw-credential access.

# Why V2 supersedes V1

V1 correctly prohibited direct credential-file/value access by the Agent/harness but expressed one prohibition too globally while also authorizing product-owned `opencode auth list`. OpenCode must internally resolve its own persisted auth store to produce the sanitized provider-id/auth-type listing. V2 makes the trust boundary explicit:

- Agent/harness direct auth-store discovery/read and credential-value access remain forbidden;
- OpenCode itself may internally resolve its own auth store only for `auth list` / `auth ls` metadata;
- landed product code may transiently capture that command's stdout only to parse it into sanitized `{provider_id: auth_type}` metadata;
- raw stdout may never be persisted, returned to the Agent/harness, or used for any provider/model request.

No V1 local execution is authorized. V1 remains immutable and must not be reused.

# Local-state separation

The authority worktree exists only for transition-gate authorization and generated gate evidence. The detached source worktree is exact canonical planning and must remain tracked-clean. Runtime evidence and the single external harness live outside Git under `F:/reverse-agent-issue220-external-session-bootstrap-v2`.
...
Only after transition preflight is `PRE_EXECUTION_AUTHORIZED`, `blocking_reasons=[]`, and `issue220v2.evidence_root_create` succeeds may the local Agent create exactly one external script:

`F:/reverse-agent-issue220-external-session-bootstrap-v2/setup_bootstrap.py`

It must never be added to Git. No other script/executable may be created.

The harness MUST NOT directly locate/read OpenCode auth/config files, obtain credential values, or expose raw auth-list stdout. Authentication visibility must be derived only through canonical trusted-host startup calling the landed product auth-metadata probe.
...
A blocker does not authorize credential inspection, auth repair, provider/model execution, repository mutation, retry under another model, or reuse of consumed/superseded #213/#215/#220-V1 authorities.
