...
{
  "schema_version": 1,
  "decision_id": "decision_20260820_issue268_product_ux2a_usage_budgets_r2_v4_landing",
  "round_id": "round_20260820_issue268_product_ux2a_usage_budgets_r2_v4_landing",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "previous_audit_outcome": "ISSUE268_PRODUCT_UX2A_R2_V3_PR270_EXACT_HEAD_ACCEPTED",
  "workstream_id": "issue268-product-ux2a-usage-budgets-r2-v4-landing",
  "source_issue": 268,
  ...
  "required_branch": "owner/issue268-product-ux2a-usage-budgets-r2-v4-landing",
  ...
  "bootstrap_exception_commands": [
    "create owner/issue268-product-ux2a-usage-budgets-r2-v4-landing from exact main aa5972a2c216a775089fbb52a5efa160f4884eb8 in an isolated canonical-LF checkout",
  ...
  "allowed_commands": [
    {
      "command_id": "issue268v4landing.verify_accepted_product",
    ...
    {
      "command_id": "issue268v4landing.run_transition_gates",
    ...
    {
      "command_id": "issue268v4landing.replay_accepted_product",
    ...
    {
      "command_id": "issue268v4landing.prepublication_validation",
      "command": "run the Issue 268 focused backend set, exact Platform V1 blocking gate, frontend Agent Runs test, frontend typecheck, frontend mock build, transition-lint, transition-preflight --mode pre, and git diff --check; prove accepted product object identity and do not require the future GitHub-assigned landing PR number",
      "phase": "validation",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue268v4landing.publish_initial_draft",
      "command": "push owner/issue268-product-ux2a-usage-budgets-r2-v4-landing once and create exactly one Draft PR with base=main; read the actual GitHub-assigned PR number without guessing; transient checks against the inherited PR 264 active intent are not acceptance evidence",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue268v4landing.bind_actual_pr",
    ...
    {
      "command_id": "issue268v4landing.final_bound_validation",
    ...
    {
      "command_id": "issue268v4landing.publish_bound_head",
    ...
    {
      "command_id": "issue268v4landing.attest_and_land",
    ...
    {
      "command_id": "issue268v4landing.post_merge_verify",
  ...
  "capability_policy": {
    ...
    "local_network_exceptions": [
      ...
      "push owner/issue268-product-ux2a-usage-budgets-r2-v4-landing once and create exactly one Draft PR with base=main; read the actual GitHub-assigned PR number without guessing; transient checks against the inherited PR 264 active intent are not acceptance evidence",
  ...
  "blocked_terminal": "ISSUE268_PRODUCT_UX2A_R2_V4_LANDING_BLOCKED_WITH_EXACT_EVIDENCE"
}
```
