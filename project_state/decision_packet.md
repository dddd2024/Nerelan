# Decision Packet — #721 safe non-overlap base refresh current-main v10

```json decision_meta
{
  "schema_version": 1,
  "decision_id": "decision_20260918_issue721_safe_base_refresh_r2_v10_current",
  "round_id": "round_20260918_issue721_safe_base_refresh_r2_v10_current",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "decision_scope": "SAFE_BASE_REFRESH_REAL_READY_ROUTE_AND_LIVE_MAIN_R2_V10",
  ...
  "previous_audit_outcome": "V6_PR946_CLOSED_REVIEW_NEGATIVE_SAFE_REFRESH_CORE_UNREACHABLE_BEFORE_PROJECT_GATE_BASE_MISMATCH;V7_LOCAL_SCOPE_INSUFFICIENT_NO_SEMANTIC_COMMIT_OR_PUBLICATION;V8_IMMUTABLE_DECISION_PREFLIGHT_BLOCKED_ALLOWED_REFERENCE_PATH_CONFLICT_NO_SEMANTIC_COMMIT_OR_PUBLICATION;V9_DECISION_ONLY_ACTIVATED_NO_SEMANTIC_COMMIT_OR_REMOTE_PUBLICATION_LOCAL_DIRTY_WORK_PRESERVED_READ_ONLY",
  "workstream_id": "issue721-safe-base-refresh-r2-v10-current",
  "source_issue": 721,
  "parent_issue": 156,
  ...
  "required_branch": "owner/issue721-safe-base-refresh-r2-v10-current",
  ...
  "fresh_worktree_contract": {
    ...
    "target_branch": "owner/issue721-safe-base-refresh-r2-v10-current",
    "worktree_path": "F:/reverse-agent-issue721-r2-v10-current",
  ...
  "semantic_implementation_contract": {
    ...
    "execution_surface_note": "Decision/source/test/commit run only in this clean isolated v10 trusted_worker checkout. Generated gate files are ephemeral with zero commit budget. Remote Decision/semantic commit graph, branch ref and Draft PR are created only through github_control_plane; local git push is forbidden. The verifier addition reuses the existing urllib REST transport and Python stdlib only.",
    "completion_boundary": "One immutable v10 Decision commit plus one semantic commit and one Draft PR. No generated-governance commit, local git push, Ready, Merge, rerun, dispatch, rebase or history rewrite."
  },
  ...
  "allowed_commands": [
    {
      "command_id": "issue721v10.bootstrap",
      "command": "Verify exact clean isolated v10 current-main checkout and immutable Decision. Run startup-snapshot, transition-command-plan, transition-lint, transition-preflight --mode pre and worktree-publication-readiness. Generated gates are ephemeral and uncommitted. Require PRE_EXECUTION_AUTHORIZED before semantic mutation.",
      "phase": "bootstrap",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue721v10.implement",
    ...
    {
      "command_id": "issue721v10.validate",
    ...
    {
      "command_id": "issue721v10.publish",
      "command": "Through github_control_plane only create the exact v10 Decision then semantic commit graph, branch owner/issue721-safe-base-refresh-r2-v10-current, and one Draft PR against main@ef8bb6959ac37301c880e0971a97a9d56e9c99a9. No local git push, Ready or Merge.",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue721v10.observe",
  ...
  "capability_policy": {
    ...
    "github_control_plane_network_exceptions": [
      "Create only the v10 Decision/semantic commit graph and branch owner/issue721-safe-base-refresh-r2-v10-current in dddd2024/Nerelan, then one Draft PR against main@ef8bb6959ac37301c880e0971a97a9d56e9c99a9; comment only on Issue721/156 and that Draft; never Ready/Merge."
    ]
  },
  "path_risk_floor": [
    {
  ...
  "run_environment_binding": {
    ...
    "target_owner_branch": "owner/issue721-safe-base-refresh-r2-v10-current",
  ...
  "approval_basis": "User delegated repository Owner execution, self-audit, and trusted-worker access via Remote Desktop Commander. Fresh current-main audit confirms #891 source correctness is landed and machine-green, #721 is the active non-overlapping source lane, and no open #721 implementation PR exists. V9 has an immutable Decision-only local commit but no semantic commit or remote publication; its dirty local semantic/gate deltas are preserved read-only. V10 starts from a fresh clean current-main worktree and authorizes only the minimum five-file route/verifier/test correction.",
  "supersedes_decision_id": "decision_20260918_issue721_safe_base_refresh_r2_v9_current",
  "superseded_evidence": "V9 Decision ed2e484a57d7f11c9470623356a3458c223808ae is immutable Decision-only local authority evidence. It has no semantic commit and no remote publication; its current uncommitted semantic/gate deltas are preserved read-only and are not an execution vehicle. V10 is a fresh clean current-main successor with no v9 history reuse.",
