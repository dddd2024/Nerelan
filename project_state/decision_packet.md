...
{
  "schema_version": 1,
  "decision_id": "decision_20260827_issue370_pr391_ready_race_containment_r2_v1",
  "round_id": "round_20260827_issue370_pr391_ready_race_containment_r2_v1",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "previous_audit_outcome": "PR391_READY_OUT_OF_SEQUENCE_CONTAINMENT_REQUIRED",
  "workstream_id": "issue370-pr391-ready-race-containment-r2-v1",
  "source_issue": 370,
  ...
  "required_branch": "owner/issue370-pr391-ready-race-containment-r2-v1",
  "risk_tier": "R2",
  ...
  "failure_root_cause": "ReadyForReviewEvent 30087233206 occurred before dry validation completed at approximately 2026-08-27T06:53:20Z",
  "containment_actions": [
    "readbacks",
  ...
  "expected_pr_state": "OPEN_READY_CLEAN",
  "expected_mergeable": "MERGEABLE",
  "expected_merge_state_status": "CLEAN",
