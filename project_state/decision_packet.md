...
{
  "schema_version": 1,
  "decision_id": "decision_20260824_issue325_pr338_attested_landing_r2_v3",
  "round_id": "round_20260824_issue325_pr338_attested_landing_r2_v3",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "validated_candidate_issue_comment_count": 0,
  "validated_candidate_review_thread_count": 0,
  "workstream_id": "issue325-pr338-attested-landing-r2-v3",
  "required_branch": "owner/issue325-pr338-attested-landing-r2-v3",
  ...
  "bootstrap_exception_commands": [
    ...
    "create owner/issue325-pr338-attested-landing-r2-v3 from 122f91ff451929f34cd71e918d88f1512d020d1d in an isolated worktree and commit this immutable Decision as the unique first new commit",
...
Execute the owner-approved Issue #325 Path-B landing round for the already accepted PR #338 head `2c3cf5a52853b2504b908f621613f0ac5003319c`, using a fresh immutable Decision-first branch from `main@122f91ff451929f34cd71e918d88f1512d020d1d`. Generate only the bounded governance artifacts, then stop at the exact remote landing boundary until every remote observation, comment timestamp, expected-head, and post-merge check is independently satisfied.

## Acceptance

1. This Decision is the unique first commit on `owner/issue325-pr338-attested-landing-r2-v3`, the worktree starts at and remains based on `main@122f91ff451929f34cd71e918d88f1512d020d1d`, and the Decision blob is immutable after activation.
