# Decision Packet — #721 safe non-overlap base refresh current-main v12

```json decision_meta
{
  "schema_version": 1,
  "decision_id": "decision_20260919_issue721_safe_base_refresh_r2_v12_current",
  "round_id": "round_20260919_issue721_safe_base_refresh_r2_v12_current",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "decision_scope": "SAFE_BASE_REFRESH_V11_SEMANTICS_PLUS_DELEGATED_GOVERNANCE_REFERENCE_R2_V12",
  ...
  "previous_audit_outcome": "V11_PR950_MACHINE_GREEN_REVIEW_NEGATIVE_DELEGATED_GOVERNANCE_REFERENCE_OMITTED_FROM_AUTHORITY_SENSITIVE_SET;PR950_CLOSED_UNMERGED;PR947_TERMINAL_MACHINE_NEGATIVE_CLOSED_UNMERGED;FRESH_V12_REQUIRED_NO_HISTORY_REUSE",
  "workstream_id": "issue721-safe-base-refresh-r2-v12-current",
  "source_issue": 721,
  "parent_issue": 156,
  ...
  "required_branch": "owner/issue721-safe-base-refresh-r2-v12-current",
  ...
  "landing_authority_scope_note": "Exactly the five authorized semantic/test paths may be re-materialized: reverse_agent/github_remote_verifier.py, reverse_agent/mainline_landing.py, reverse_agent/project_gate.py, tests/test_mainline_landing.py and tests/test_project_gate.py. V12 must preserve the corrected cutover base-drift regression and additionally classify docs/agents/governance-reference.md as an exact authority-sensitive path with focused fail-closed coverage; no blanket docs/** classification. No workflow/dependency/frontend/database/schema/scheduler/framework mutation; no Ready/Merge/rerun/dispatch/history rewrite.",
  ...
  "source_test_mutation_scope": "V11_EXACT_FIVE_FILE_SEMANTICS_PLUS_DELEGATED_GOVERNANCE_REFERENCE_AUTHORITY_SENSITIVE_CLASSIFICATION_AND_FOCUSED_NEGATIVE_TESTS",
  ...
  "historical_negative_authority": {
    ...
    "pr947_v9_disposition": "TERMINAL_DRAFT_MACHINE_NEGATIVE_SINGLE_STALE_TEST_CONTRACT_CLOSED_UNMERGED",
    "pr950_v11": "914f7b9ec104a8865ccb5c468d41937191244d42",
    "pr950_v11_disposition": "CLOSED_UNMERGED_MACHINE_GREEN_REVIEW_NEGATIVE_DELEGATED_GOVERNANCE_REFERENCE_OMISSION",
  ...
  "refresh_negative_matrix": {
    ...
    "N2_authority_sensitive_drift": "github_project_state_agents_and_delegated_governance_reference_landing_governance_drift_must_block",
  ...
  "fresh_worktree_contract": {
    ...
    "target_branch": "owner/issue721-safe-base-refresh-r2-v12-current",
    "worktree_path": "F:/reverse-agent-issue721-r2-v12-current",
  ...
  "semantic_implementation_contract": {
    "specification": "Re-materialize the exact audited v11 five-file product/test semantics from PR950/tree c88d9fbeb82b9bd572fd47acc7313caef23aefdc as content evidence only, preserving the --no-renames changed-path fix and corrected cutover base-drift regression. Add docs/agents/governance-reference.md as an exact authority-sensitive path and focused negative tests proving intervening drift there blocks safe refresh. Preserve AGENTS.md blocking and prove unrelated ordinary docs do not become authority-sensitive. Production validation must not be weakened.",
    "execution_surface_note": "Decision/source/test/commit run only in this fresh isolated v12 trusted_worker checkout. No cherry-pick/rebase/history reuse. Generated gates are ephemeral. Remote Decision/semantic graph, branch and one Draft PR only through github_control_plane; no local git push.",
    "completion_boundary": "One immutable v12 Decision commit plus one semantic commit and one Draft PR. No generated-governance commit, second semantic commit, rerun, Ready, Merge, rebase, amend, squash, force push or history rewrite. Exact-head review must explicitly cover delegated governance-reference drift."
  },
  ...
  "allowed_commands": [
    {
      "command_id": "issue721v12.bootstrap",
      "command": "Verify exact clean isolated v12 current-main checkout and immutable Decision. Run startup-snapshot, transition-command-plan, transition-lint, transition-preflight --mode pre and worktree-publication-readiness. Require PRE_EXECUTION_AUTHORIZED before semantic mutation.",
      "phase": "bootstrap",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue721v12.implement",
      "command": "After PRE_EXECUTION_AUTHORIZED re-materialize the exact audited v11 five-file content evidence from PR950 as content only, preserving the --no-renames path fix and corrected cutover regression. Add docs/agents/governance-reference.md as an exact authority-sensitive path and focused regressions proving that delegated-governance drift blocks while unrelated ordinary docs do not. No cherry-pick/rebase/history reuse. Commit exactly once.",
    ...
    {
      "command_id": "issue721v12.publish",
      "command": "Through github_control_plane only create the exact v12 Decision then semantic commit graph, branch owner/issue721-safe-base-refresh-r2-v12-current, and one Draft PR against main@ef8bb6959ac37301c880e0971a97a9d56e9c99a9. No local git push, rerun, Ready or Merge.",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue721v12.observe",
  ...
  "capability_policy": {
    ...
    "github_control_plane_network_exceptions": [
      "Create only the v12 Decision/semantic commit graph and branch owner/issue721-safe-base-refresh-r2-v12-current in dddd2024/Nerelan, then one Draft PR against main@ef8bb6959ac37301c880e0971a97a9d56e9c99a9; comment only on Issue721/156 and that Draft; never rerun/Ready/Merge."
    ]
  },
  "path_risk_floor": [
    {
  ...
  "run_environment_binding": {
    ...
    "target_owner_branch": "owner/issue721-safe-base-refresh-r2-v12-current",
  ...
  "approval_basis": "User explicitly delegated repository Owner execution, self-audit and Remote Desktop Commander trusted-worker access. Fresh server truth keeps main at ef8bb695..., #721 active, PR947 closed terminal machine-negative, and PR950 closed terminal machine-green/review-negative. V12 reuses the audited v11 five-file semantics as content evidence only and corrects the exact delegated-governance-reference omission found by exact-head review; no predecessor Git history/check/review is current authority.",
  "supersedes_decision_id": "decision_20260919_issue721_safe_base_refresh_r2_v11_current",
  "superseded_evidence": "PR950@914f7b9ec104a8865ccb5c468d41937191244d42 is CLOSED_UNMERGED machine-green review-negative evidence: natural CI 35432152074, Decision Preflight 35432152081 and State Gate 35432152077 succeeded, but exact-head review found docs/agents/governance-reference.md delegated by AGENTS.md and referenced by the Decision was omitted from the authority-sensitive drift matcher. V11 consumed its sole semantic commit budget and permits no correction push. PR947@7d1bc01e... remains CLOSED_UNMERGED terminal machine-negative stale-test chronology. No rerun/Ready/Merge or history reuse.",
...
Preserve the audited v11 #721 production semantics and close the delegated-governance-reference authority dependency gap: intervening drift in docs/agents/governance-reference.md must block safe refresh exactly like other authority-sensitive drift, while unrelated ordinary docs remain eligible for normal non-overlap evaluation.

## Build vs reuse

Reuse the exact audited v11 five-file semantics as content evidence, landed #891 role split, GitHubRemoteAcceptanceVerifier, system Git and git merge-tree. The only new semantic change is exact classification of docs/agents/governance-reference.md as authority-sensitive plus focused regressions. Do not broaden to docs/**. No scheduler, queue, new GitHub client, Git library, workflow, dependency, database or schema.
