...
```json decision_contract
{
  ...
  "previous_audit_outcome": "PR390_V8_FAILED_UNPUBLISHED_BINDING_TLS_EOF_AFTER_SECOND_PUSH",
  "workstream_id": "issue370-strict-freshness-control-r2-v10",
  "source_issue": 370,
  ...
  "required_branch": "owner/issue370-strict-freshness-control-r2-v10",
  "risk_tier": "R2",
  ...
  "bootstrap_exception_commands": [
    "verify exact main base 0b1f30129fa770f394d7eb6d844fa962ea5a7cde and fresh strict-freshness-control v10 branch merge-base",
  ...
  "allowed_commands": [
    {
      "command_id": "issue370_r2v10.bootstrap",
      "command": "verify locked main base and fresh strict-freshness-control v10 branch; commit the immutable Decision as the unique first commit; generate the five governance gates; require PRE_EXECUTION_AUTHORIZED and PUBLICATION_READY",
      "phase": "bootstrap",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue370_r2v10.diff_check",
    ...
    {
      "command_id": "issue370_r2v10.publish_control_draft",
    ...
    {
      "command_id": "issue370_r2v10.pre_ready_dry_validation",
    ...
    {
      "command_id": "issue370_r2v10.audit_attestation_comments",
    ...
    {
      "command_id": "issue370_r2v10.ready_clean_at_b",
    ...
    {
      "command_id": "issue370_r2v10.behind_revocation_closeout",
