# Decision Packet — PR893 Owner landing authority

```json decision_meta
{
  "schema_version": 1,
  "decision_id": "decision_20260915_issue894_pr893_owner_landing_r2_v1",
  "round_id": "round_20260915_issue894_pr893_owner_landing_r2_v1",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "required_branch": "owner/issue894-pr893-owner-landing-r2-v1",
  ...
  "workstream_id": "issue894-pr893-owner-landing-r2-v1",
  ...
  "approval_basis": "The user repeatedly delegated repository Owner execution and requested completion of the highest-priority non-overlapping work. Exact-head S2 audit review 5205536976 found no remaining semantic defect at de5400fe67c33e8f26517fac49f9e28d41132139. This is disclosed delegated Agent/Owner activity, not independent human review.",
  "landing_authority_scope_note": "Governance-only sidecar for target PR893 exact head de5400fe67c33e8f26517fac49f9e28d41132139 at locked main d3ffafc8924614f309a8f85b6224137f94b2d8c1. The sidecar stays Draft/unmerged. It must publish exactly one current existing-format OWNER_LANDING_MERGE_ATTESTATION while target is still Draft, then allow exactly one target Ready, require the natural formal landing-state-gate SUCCESS, fresh no-drift revalidation, and exactly one expected-head protected ordinary merge. A new natural main-push State Gate SUCCESS and unchanged post-merge false/none validation are required before closing #891.",
  ...
  "capability_policy": {
    ...
    "github_control_plane_network_exceptions": [
      "Publish only owner/issue894-pr893-owner-landing-r2-v1 and exactly one Draft sidecar against locked main d3ffafc8924614f309a8f85b6224137f94b2d8c1; keep sidecar Draft and unmerged.",
  ...
  "allowed_commands": [
    ...
    {
      "command_id": "issue894.materialize",
    ...
    {
      "command_id": "issue894.publish",
      "command": "Publish only owner/issue894-pr893-owner-landing-r2-v1 and one Draft PR against locked main d3ffafc8924614f309a8f85b6224137f94b2d8c1. Keep sidecar Draft forever and never merge or mark it Ready.",
    ...
    },
    {
      ...
      "phase": "final_evidence", "required": true, "expected_exit_codes": [0], "execution_surface": "github_control_plane", "operations": ["pull_request_comment", "network_access", "read_only_audit"], "network_access": true, "required_evidence_source": "repository_state_attestation", "allowed_mutated_paths": [], "produced_artifacts": []
    },
    {
      "command_id": "issue894.land_target",
      ...
      "phase": "final_evidence", "required": true, "expected_exit_codes": [0], "execution_surface": "github_control_plane", "operations": ["network_access", "read_only_audit"], "network_access": true, "required_evidence_source": "repository_state_attestation", "allowed_mutated_paths": [], "produced_artifacts": []
    }
  ],
...
Authorize only the exact no-drift landing of accepted PR #893, using the repaired acyclic false/none attestation lifecycle, then require a new natural main-push State Gate success before #891/#894 closure.
