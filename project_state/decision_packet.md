...
{
  "schema_version": 1,
  "decision_id": "decision_20260824_issue345_scope_aware_workflow_policy_r2",
  "round_id": "round_20260824_issue345_scope_aware_workflow_policy_r2",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "follows_last_decision_id": "decision_20260824_issue343_playwright_recovery_r3_v2",
  "follows_last_round_id": "round_20260824_issue343_playwright_recovery_r3_v2",
  "previous_audit_outcome": "PR344_MERGED_CB6E7A3E3B92935525079278E327843FD1F2D03E_POLICY_GAP_TRACKED_IN_345",
  "workstream_id": "issue345-scope-aware-workflow-policy-r2",
  "source_issue": 345,
  "parent_issue": 343,
  "superseded_source_pr": 344,
  "superseded_source_head_sha": "50d54db6308dcb6ba1e655c7099edb61a10c13e9",
  ...
  "required_branch": "owner/issue345-scope-aware-workflow-policy-r2",
  "risk_tier": "R2",
  ...
  "allowed_commands": [
    {
      "command_id": "issue345_r2.bootstrap",
    ...
    {
      "command_id": "issue345_r2.trusted_profiles_and_v3_intent",
    ...
    {
      "command_id": "issue345_r2.v3_schema",
    ...
    {
      "command_id": "issue345_r2.profile_regressions",
    ...
    {
      "command_id": "issue345_r2.validate_and_publish",
    ...
    {
      "command_id": "issue345_r2.bind_intent",
    ...
    {
      "command_id": "issue345_r2.final_push_and_audit",
  ...
  "success_terminal": "ISSUE345_R2_SCOPE_AWARE_WORKFLOW_PROFILE_POLICY_DRAFT_ACCEPTED_FOR_OWNER_LANDING",
  "blocked_terminal": "ISSUE345_R2_BLOCKED_WITH_EXACT_EVIDENCE"
}
```
