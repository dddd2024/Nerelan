...
{
  "schema_version": 1,
  "decision_id": "decision_20260912_issue843_visible_goal_evidence_r3_v7",
  "round_id": "round_20260912_issue843_visible_goal_evidence_r3_v7",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "source_issue_body_sha256": "ce2600d7911092a94928adb76eea054cffeaa63cfb52cdd12d2388ef3120ab45",
  ...
  "required_branch": "codex/f03-visible-goal-evidence-r3-v7",
  ...
  "allowed_commands": [
    {
      "command_id": "issue843.bootstrap",
      "command": "Observe main exactly1b87cb41606bfbda0b4b49dd18259550fbf5bb58, accepted PR827 native receipt/main CI and fresh clean branchcodex/f03-visible-goal-evidence-r3-v7; commit this immutable APPROVED R3 Decision alone as the first activation commit. Run existing startup-snapshot, transition-command-plan, transition-lint, transition-preflight --mode pre and worktree-publication-readiness. Require PRE_EXECUTION_AUTHORIZED and PUBLICATION_READY before product mutation or any browser/server launch. Do not copy prior Decision/gates/history.",
      "phase": "bootstrap",
      "required": true,
      "expected_exit_codes": [
        0
    ...
    {
      "command_id": "issue843.implement",
      "command": "Implement only the23 product paths in Issue843. After fresh Decision-only activation and PRE_EXECUTION_AUTHORIZED, reuse the17 frozen839 product files after SHA256/base-blob verification. Retain all Goal proof, fail-closed provenance, exact Run links, publication/review distinctions, truthful labels and recovery/query semantics. Apply the user-requested existing-style refinement through current Home, GoalProgress, GoalComposer, GoalCurrentActivity, Settings, ThemeSelector, ConnectionBindingEditor and CSS: readable hierarchy, compact task status, restrained surfaces, clear recent rows, concise nonclipped mobile placeholder, consistent theme cards/fields/button focus. Keep48pxdesktop/16pxmobile Home gutters,12px task vertical padding, existing palette/sidebar/single-column flow, compact settings index, all meaningful status and controls. No runtime/auth/credential/provider/API/schema/workflow/dependency/snapshot behavior change. No second store/verifier or new route/assets. Preserve all stopped work and PR819/841. All checks run anew; prior history/results confer no acceptance.",
    ...
    {
      "command_id": "issue843.publish",
      "command": "After all exact-head local and real browser checks pass, push onlycodex/f03-visible-goal-evidence-r3-v7 todddd2024/Nerelan and create exactly one Draft against main@1b87cb41606bfbda0b4b49dd18259550fbf5bb58. One successful push and one successful Draft only; at most3 transport attempts overall, only after readback confirms no mutation. After successful push no further push. Publish disclosed review/evidence and bounded progress comments only to Issue843, its exact Draft,653 and659. Do not mutate other branches/Issues/PRs or repeat completed826 closure.",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [
        0
  ...
  "run_environment_binding": {
    ...
    "target_owner_branch": "codex/f03-visible-goal-evidence-r3-v7",
