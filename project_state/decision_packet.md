...
{
  "schema_version": 1,
  "decision_id": "decision_20260819_issue250_ci_repair_r2_v3",
  "round_id": "round_20260819_issue250_ci_repair_r2_v3",
  "status": "APPROVED",
...
```json decision_contract
{
  ...
  "follows_last_decision_id": "decision_20260819_issue250_ci_repair_r2_v2",
  "follows_last_round_id": "round_20260819_issue250_ci_repair_r2_v2",
  "previous_audit_outcome": "ISSUE250_V2_PLATFORM_SUITE_BLOCKED_BY_UNCONDITIONAL_ACTIVE_MERGE_INTENT_BINDING",
  "workstream_id": "issue250-ci-repair-r2-v3",
  "source_issue": 250,
  "superseded_pr": 251,
  "required_branch": "owner/issue250-platform-completion-v3",
  ...
  "authority_and_product_worktree": "F:/reverse-agent-issue250-platform-completion-v3",
  "risk_tier": "R2",
  ...
  "bootstrap_exception_commands": [
    "git worktree add -b owner/issue250-platform-completion-v3 F:/reverse-agent-issue250-platform-completion-v3 706991ad0cb826d7c963a8ddfb7e770e97cdf60b",
  ...
  "allowed_commands": [
    {
      "command_id": "issue250v3.verify_exact_state",
    ...
    {
      "command_id": "issue250v3.reuse_exact_product_commit",
    ...
    {
      "command_id": "issue250v3.install_frontend_lockfile",
    ...
    {
      "command_id": "issue250v3.fix_engineering_decision_contract",
      "command": "make active-merge artifact assertions conditional on mainline_merge_intent_required while preserving the default and landing behavior",
      "phase": "implementation",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue250v3.fix_frontend_lint",
    ...
    {
      "command_id": "issue250v3.frontend_validation",
    ...
    {
      "command_id": "issue250v3.backend_validation",
    ...
    {
      "command_id": "issue250v3.platform_validation",
    ...
    {
      "command_id": "issue250v3.repository_validation",
    ...
    {
      "command_id": "issue250v3.commit_lint_repair",
      "command": "git add only frontend/src/lib/platform-client.ts frontend/src/routes/home.tsx tests/platform_v1/test_merge_intent.py tests/platform_v1/test_contracts.py; git commit -m 'fix: satisfy engineering Decision CI contracts'",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue250v3.push_once",
      "command": "git push origin HEAD:refs/heads/owner/issue250-platform-completion-v3",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
    ...
    {
      "command_id": "issue250v3.replace_draft_pr",
      "command": "close PR 251 as superseded, create one Draft PR from owner/issue250-platform-completion-v3 to main, and comment Issue 250",
      "phase": "publication",
      "required": true,
      "expected_exit_codes": [0],
      "execution_surface": "local",
  ...
  "success_terminal": "ISSUE250_V3_REPLACEMENT_DRAFT_PR_EXACT_HEAD_CI_READY",
  "blocked_terminal": "ISSUE250_V3_CI_REPAIR_BLOCKED_WITH_EXACT_EVIDENCE"
}
```
...
2. The accepted v1 product tree is replayed exactly before the two-file lint repair and the bounded active-merge contract correction.
