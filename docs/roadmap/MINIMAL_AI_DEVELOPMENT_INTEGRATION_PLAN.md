...
All other publication/network activity, including direct `main` push, history rewrite, workflow/dependency publication, cross-repository publication, credentials access, tag, and release, is R2 or higher.
